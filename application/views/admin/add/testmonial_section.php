...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($testmonial_detail)) echo site_url('admin/edit_section_3'); else echo site_url('admin/add_section_3'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
