...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($admin_detail)) echo site_url('admin/edit_coming_soon'); else echo site_url('admin/add_coming_soon'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
