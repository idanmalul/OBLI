...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($icon_detail)) echo site_url('admin/edit_icon'); else echo site_url('admin/add_icon'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
