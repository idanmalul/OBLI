...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($banner_detail)) echo site_url('admin/edit_banner'); else echo site_url('admin/add_banner'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
                ...
                <textarea name="sub_title" id="text_area" class="form-control ck_textarea_visible" placeholder="" rows="5" ><?php if(!empty($banner_detail)){ echo htmlspecialchars(trim($banner_detail[0]->sub_title)); }else{ if(isset($_POST['sub_title'])){ echo trim($_POST['sub_title']); } }?></textarea>
