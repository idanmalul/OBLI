...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($app_link_detail)) echo site_url('admin/edit_app_url'); else echo site_url('admin/add_app_url'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
