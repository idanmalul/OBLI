...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($menu_detail)) echo site_url('admin/edit_menu'); else echo site_url('admin/add_menu'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
