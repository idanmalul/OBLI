    ...
    $(function() {
      ...
      $('input[name="gur_period_month"]').on('apply.daterangepicker', function(ev, picker) {
          ...
          // alert($("#gur_period_month").val());
            ...
            if($("#busineesThird_requested_gurantee_amt").val() != '' && $("#gur_period_month").val() != '' && $('#checkbox3').is(":checked") && $('#checkbox4').is(":checked") != '' && $("#first_bae64_sign").val() != '' && $("#second_bae64_sign").val() != '' && $("#third_bae64_sign").val() != '' ){
                // alert(1);
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-10 rtl" style="text-align: right;">
                           ...
                           <p class="check_box_para" style="margin-top: 30px;">
                               ...
                               שים לב! ערבות בין הסכומים 50,000  ש”ח עד 100,000 ש”ח דורשת ערב נוסף
                           </p><p>
                            ...
                            <div class="modal-body">
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-10 rtl" id="modal3Div" style="text-align: right;">
                                   ...
                                   בין   <?php if(!empty($businessThird2)){ echo $businessThird2['company_name']; }?>      ח.פ. <?php if(!empty($businessThird2)){ echo $businessThird2['company_id']; }?> (להלן: "הערב")

                                   <br>
                                     

                                  מ <?php if(!empty($businessThird2)){ echo $businessThird2['company_address']; }?><br>
                                   ...
                                   והערב עוסקת במתן שירותי אשראי והינה בעלת רישיון למתן אשראי כהגדרתו בחוק הפיקוח על שירותים פיננסיים (שירותים פיננסיים מוסדיים), התשע"ו-2016; <br><b>והואיל </b>
                        ...
                        <!-- <span id="span_br"> <br></span> --><br><br><br>
                         <div class="row cale_opn cala_margin1">
                            ...
                            <div class="first_button_new-text2" id="myBtn2"> 
                                ...
                                <a class=""> 
                                    <p class="first_button-new first_button_responsive p1_res p3_new" style="margin-top:25px;  margin-left:70px; ">בקשה לפריסת עמלת הערבות </p>
                                </a>
                            ...
                            <div class="first_button_new-text1" id="myBtn1" style="margin-top:0px;"> 
                                ...
                                <a>
                                    <p class="first_button-new first_button_responsive p2_res p3_new" style="margin-top:25px; margin-left:20px;">הסכמה למסירת נתוני אשראי </p>
                                </a>    
