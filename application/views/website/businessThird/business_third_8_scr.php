      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <!--<form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php //echo site_url('businessThird9/'.base64_encode($this->session->userdata('url_user_document')).'/'. base64_encode('satendra.tectum@gmail.com')); ?>" >-->
            ...
            <div id="business_10_scr" class="gform_body form_height" style="margin-top: 30px;">
                   ...
                   <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <!-- <button type="submit" class="button gform_button first_main_button" id="businessThird_8_form" style="height: 60px; width: 328px;">חזור לדף הבית  </button> -->
                             <button type="submit" class="button gform_button first_main_button" id="businessThird_8_form" style="height: 60px; width: 328px;"> סיים  </button>
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
