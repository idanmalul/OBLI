			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-3 col-sm-12 col-xs-12 footer-paly-store-image">
					<ul class="playstore">
						...
						<li>
							<a href="<?php if(!empty($application_url_details)){ echo $application_url_details[0]->first_app_url; }else{ echo '#'; } ?>"><img src="<?php echo base_url() ?>website_assets/img/applestore.svg"/></a></li>
						<li>
							<a href="<?php if(!empty($application_url_details)){ echo $application_url_details[0]->second_app_url; }else{ echo '#'; } ?>"><img src="<?php echo base_url() ?>website_assets/img/playstore.svg"/></a>
						</li>
						<li>
							<p>:להורדה  </p>
						</li>
