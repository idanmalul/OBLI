      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessSecPaymentPage'); ?>" >
            <!-- screen 4/5 -->
            <div id="business_7_scr" class="gform_body form_height" style="margin-top: 30px;">
                    ...
                    <ul class="gform_fields top_label ">
                        ...
                        <div class="col-md-12 col-sm-12">
                          <div class=""><iframe class="iframe_height" width="100%" height="100%"  src="<?php if(!empty($this->session->userdata('businesSec_payment_api_link'))){ echo $this->session->userdata('businesSec_payment_api_link'); } ?>"></iframe></div>
                        </div>
                    </div>   
                        </li>
                   ...
                   <div class="row" style="margin-top:50px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <!--<button type="submit" class="button gform_button first_main_button" id="businessSec_payment_page_form" style="height: 60px; width: 328px;">המשך  </button>-->
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
