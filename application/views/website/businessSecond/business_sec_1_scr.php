...
// end
        ...
        $(document).ready(function(){
            ...
            $("#businessSec_1_form").css("opacity","0.5"); 
            $("#businessSec_1_form").css("cursor","auto");
            $('#businessSec_1_form').prop('disabled', true);
            // $('#businessSec_1_form').prop('disabled', false);
            ...
            $('#first_name,#last_name,#unique_id,#hometown,#street,#home_no,#client_phone,#client_email').on('keyup', function() {
                ...
                if($("#first_name").val() != '' && $("#last_name").val() != '' && $("#unique_id").val() != '' && $("#hometown").val() != ''  && $("#street").val() != '' && $("#home_no").val() != '' && $("#client_phone").val() != '' && $("#client_email").val() != '' && $("#datepicker").val() != '' && $("#file-2").val() != '' ){
                    ...
                    $("#businessSec_1_form").css("opacity","1"); // button opacity change
                    $("#businessSec_1_form").css("cursor","pointer");
                    $('#businessSec_1_form').prop('disabled', false);
            ...
            $("#businessSec_1_form").click(function(){
                ...
                var form = $("#myform");
                    ...
                    if (form.valid() === true){
                        ...
                        $("#businessSec_1_form").css("opacity","1"); 
                        $("#businessSec_1_form").css("cursor","pointer");
                        $('#businessSec_1_form').prop('disabled', false);
                    }
                    else{
      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessSec1'); ?>" novalidate>
                  ...
                  <div class="gform_footer top_label"> 
                        ...
                        <button type="submit" class="button gform_button first_next_button screen-button-obli screen-button2-obli screen-button3-obli screen_2_buttons padding_screen02 text_size" id="businessSec_1_form" style="margin: 0px 180px;">המשך</button>
                    </div>
