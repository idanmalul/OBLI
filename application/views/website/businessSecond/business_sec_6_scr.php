      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessSec6'); ?>" >
            <!-- screen 4/5 -->
            <div id="business_7_scr" class="gform_body form_height" style="margin-top: 30px;">
                   ...
                   <div class="row" style="margin-top:40px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <button type="submit" class="button gform_button first_main_button" id="businessSec_6_form" style="height: 60px; width: 328px;">המשך  </button>
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
...
//        alert($("#b10_second_file").val());
            ...
            $("#businessSec_6_form").css("opacity","1");
            $("#businessSec_6_form").css("cursor","pointer");
            $("#businessSec_6_form").prop("disabled", false);

    }else{
//        alert(2);
//        alert($("#b10_second_file").val());
        $("#businessSec_6_form").css("opacity","0.5");
        $("#businessSec_6_form").css("cursor","auto");
        $("#businessSec_6_form").prop("disabled", true);
    }
}
// end
...
//    document.getElementById('for_file_label1').style.display = "none"
    ...
    if($("#b10_first_file").val() != '' && $("#b10_second_file").val() != '' && $("#b10_third_file").val() != '' && $("#b10_fourth_file").val() != '' && $("#b10_fifth_file").val() != '' && $("#b10_sixth_file").val() != '' ){
            ...
            $("#businessSec_6_form").css("opacity","1"); // button opacity change
            $("#businessSec_6_form").css("cursor","pointer");
            $("#businessSec_6_form").prop("disabled", false);

    }else{
        $("#businessSec_6_form").css("opacity","0.5"); // button opacity change
        $("#businessSec_6_form").css("cursor","auto");
        $("#businessSec_6_form").prop("disabled", true);
    }
}
...
// end
    ...
    $(document).ready(function(){
        ...
        $("#businessSec_6_form").click(function(){
          var form = $("#myform");
                form.validate({
                    errorElement: 'span',
