...
<!--                                <img src="<?php //echo base_url() ?>website_assets/img/dropdown_icon.png" class="img-responsive cal_reponsive1" style="position: relative; left: -266px; top: -22px;">-->
                  ...
                  <div class="gform_footer top_label"> 
                        ...
                        <button type="submit" class="first_next_button screen-button-obli screen-button2-obli screen-button3-obli screen_2_buttons padding_screen02 text_size" id="business_sec_4_form" style="margin: 35.5px 180px;">המשך</button>
