    ...
    $(function() {
      ...
      $('input[name="gur_period_month"]').on('apply.daterangepicker', function(ev, picker) {
          ...
          // alert($("#gur_period_month").val());
            ...
            if($("#businessSec_requested_gur_amount").val() != '' && $("#gur_period_month").val() != '' ){
                // alert(1);
                    $("#businessSec_3_form").css("opacity","1"); // button opacity change
                    $("#businessSec_3_form").css("cursor","pointer");
                    $("#businessSec_3_form").prop("disabled", false);
                
            }else{ 
                // alert(2);
                $("#businessSec_3_form").css("opacity","0.5"); // button opacity change
...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#businessSec_3_form").click(function(){
...
//                console.log('clicked');
                ...
                form.validate({
                    ...
                    rules: {
                        businessSec_requested_gur_amount: {
                           required: true,
                            money: true,
                            min: 100,
                            max: 100000
                ...
                if (form.valid() === true){
                    ...
                    gurant_amm = $("#businessSec_requested_gur_amount").val();
...
//                    }
            ...
            // second form  
            $('#businessSec_requested_gur_amount').on('keyup', function() {
            ...
            $("#myBtn2").click(function(){
                ...
                // popup dynamic js 
                var firstName = '<?php if(!empty($this->session->userdata("businessSec1"))){ $businessSec1 = $this->session->userdata("businessSec1");  echo $businessSec1["first_name"]; } ?>';
                var lastName = '<?php if(!empty($this->session->userdata("businessSec1"))){ $businessSec1 = $this->session->userdata("businessSec1");  echo $businessSec1["last_name"]; } ?>';
                var client_id = '<?php if(!empty($this->session->userdata("businessSec1"))){ $businessSec1 = $this->session->userdata("businessSec1");  echo $businessSec1["unique_id"]; } ?>';
            ...
            $("#myBtn3").click(function(){
                ...
                var firstName = '<?php if(!empty($this->session->userdata("businessSec1"))){ $businessSec1 = $this->session->userdata("businessSec1");  echo $businessSec1["first_name"]; } ?>';
                var lastName = '<?php if(!empty($this->session->userdata("businessSec1"))){ $businessSec1 = $this->session->userdata("businessSec1");  echo $businessSec1["last_name"]; } ?>';
                var clientAdd = '<?php if(!empty($this->session->userdata("businessSec1"))){ $businessSec1 = $this->session->userdata("businessSec1");  echo $businessSec1["home_no"].", ".$businessSec1["hometown"].", ".$businessSec1["street"]; } ?>';
                ...
                var cAmount = $('#businessSec_requested_gur_amount').val();
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-10 rtl" id="modal3Div" style="text-align: right;">
                                  ...
                                  פיננסיים (שירותים פיננסיים מוסדיים), התשע"ו-2016;  <br><b>והואיל </b>
                                   ...
                                   <p style="margin: 10px 40px -40px 0px;text-align: center;"> <b>חתימת גולדנרוד (הערבה) </b></p>
                        ...
                        <li class="gfield gfield_html gfield_no_follows_desc text_resp">
                           ...
                           <div class="" style="float: right; margin-left:15px; margin-top:-25px;">
                            ...
                            <p class="contact-text_application main_text_heading"style="font-weight: bold; ">סכום הערבות </p>
                             ...
                             <p class="contact-text_application" style="margin-top: -20px;">השלב הבא: פרטים על הספק </p>
                         </div>
                         </li>
                    ...
                    <!-- <div class="row" style="margin-top: 70px;"> -->
                        ...
                        <li class="gf_middle_third gfield text-field1_application form-group">
                            ...
                            <div class="styled-input wide" >
                               <input type="text" name="businessSec_requested_gur_amount" id="businessSec_requested_gur_amount" value="" class="form-control fouth_text" autocomplete="off" required="">

                        
                                <label class="gfield_label control-label gform_wrapper gfield_label" for="businessSec_requested_gur_amount">סכום הערבות המבוקש  
                            </label>
                            </div> 
                        </li>
...
<!--                        <div class="row cale_opn">
                        ...
                        <button type="button" class="button gform_button first_button-new continue_button first_next_button lowerbutton1" id="businessSec_3_form" style="height: 60px; width: 328px;">המשך</button>
...
//                    setInterval(function(){ console.log("delay"); },32000);
    ...
    var gurant_amm = $("#businessSec_requested_gur_amount").val();
    ...
    if(gurant_amm > 50000){
        ...
        <?php $businessSec2 = $this->session->userdata('businessSec2');
...
//        return false;
        $.ajax({
                url: "<?php echo site_url('BusinessSec/business_payment_api'); ?>",
                type: "POST",
                data: form,
//                contentType: false,
//                cache: false,
...
//                            }
                            ...
                            location.href = "<?php echo site_url('businessSec4'); ?>";
                                
                        }
                        else
                        {
                           location.href = "<?php echo site_url('businessSecBadResponse'); ?>";
                        }
                    }
                    else{
                        alert('Eroor!');
...
//        return false;
        $.ajax({
                url: "<?php echo site_url('BusinessSec/business_without_payment_api'); ?>",
                type: "POST",
                data: form,
//                contentType: false,
//                cache: false,
...
<script type="text/javascript">
	$('#businessSec_requested_gur_amount').simpleMoneyFormat();
</script>