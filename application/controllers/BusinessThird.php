...
//            redirect('businessThird7');
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessThird/business_third_6_scr');
            $this->load->view('website/footer', $data);
        }
    }
...
//             die();
            ...
            // api call
            $url = 'https://obli-backend.herokuapp.com/webservices/businessThirdOrderDetails.php';
...
//                            redirect('business1');
                         ...
                         $session_array = array( 'businessThird2', 'businessThird3', 'businessThird4', 'businessThird5', 'businessThird6', 'businessThird7', 'businessThird8', 'businessThird9');
                        $this->session->unset_userdata($session_array);
