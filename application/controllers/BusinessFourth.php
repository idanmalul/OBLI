...
class BusinessFourth extends CI_Controller {
    ...
    function business_fourth_Form1(){
...
//            print_r($this->session->userdata()); die();
            ...
            $businessFourth1 = $this->session->userdata('businessFourth1');
            $first_name = $businessFourth1['first_name'];
            $last_name = $businessFourth1['last_name'];
            $unique_id = $businessFourth1['unique_id'];
            $client_hometown = $businessFourth1['hometown'];
            $client_street = $businessFourth1['street'];
            $client_home_no = $businessFourth1['home_no'];
            $client_phone = $businessFourth1['client_phone'];
            $client_phone = str_replace(["-"], '', $client_phone);
            $client_email = $businessFourth1['client_email'];
            $client_gender = $businessFourth1['client_gender'];
            $client_date_of_birth = strtr($businessFourth1['client_date_of_birth'], '/', '-');
            $client_date_of_birth = date('Y-m-d', strtotime($client_date_of_birth));
            $client_first_file = $businessFourth1['user_first_file'];
...
//            die();
            ...
            $url = 'https://obli-backend.herokuapp.com/webservices/businessFourthClientDetails.php';
            ...
            if($err){
                // echo $err;
              //  $session_array = array('businessFourth1');
              //  $this->session->unset_userdata($session_array);
                echo "<script type='text/javascript'>alert('Error!'); window.location.href = '".site_url('businessFourth1')."'; </script>";
                return FALSE;
                 ...
                 if(!empty($clientData)){
                     if($clientData->status == "true"){ 
                         if($clientData->client_reponse_data[1]->_hc_lastop == "FAILED"){
                           ...
                           // $session_array = array('businessFourth1');
                           // $this->session->unset_userdata($session_array);
                            echo "<script type='text/javascript'>alert('Your record is rejected, Please try again!'); window.location.href = '".site_url('businessFourth1')."'; </script>";
//                            redirect('business1');
                            return FALSE;
...
//                             alert('Your record successfully saved!');
                           ...
                           echo "<script type='text/javascript'>window.location.href = '".site_url('businessFourth2')."';</script>";
                           return FALSE;
...
//            redirect('businessFourth2');
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_1_scr');
            $this->load->view('website/footer', $data);
        }
        
    }
    
    function business_fourth_Form2(){
...
//            print_r($this->session->userdata());die();
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_2_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function business_fourth_Form3(){
...
//            print_r($this->session->userdata());die();
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_3_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function business_fourth_Form4(){
//        echo '<pre>';
...
//                    die();
                    ...
                    if(empty($rec)){
                        ...
                        $this->load->view('website/header');
                        $this->load->view('website/businessFourth/business_fourth_4_scr', $form_data);
                        $this->load->view('website/footer', $footer_data);
//                        redirect('business7');
                        return false;  
//                        die();
                    }else{
                        redirect('businessFourth5');
                    }
                }
                elseif(@$cmp[1] == 2){
                    redirect('businessFourth5');
...
//            redirect('businessFourth5');
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_4_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function business_fourth_Form5(){
...
//            print_r($this->session->userdata());die();
            ...
            $businessFourth2 = $this->session->userdata('businessFourth2');
            ...
            if(!empty($businessFourth2)){
                ...
                if(!empty($business_type)){
                    if($business_type == 'חברה בע”מ'){
                       ...
                       redirect('businessFourth6');

                    }else{
                        $this->businessFourthAllFormSubmit();
                    }
                }
                else{
                    redirect('business1');
...
//            redirect('businessFourth6');
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_5_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function business_fourth_Form6(){
...
//            print_r($data);
            ...
            if(isset($_FILES["b10_first_file"]["name"])) {
                ...
                $custom_name = "bfourth1_" . $today.rand(10,100);
            ...
            if(isset($_FILES["b10_second_file"]["name"])) {
                ...
                $custom_name = "bfourth2_" . $today.rand(10,100);
            ...
            if(isset($_FILES["b10_third_file"]["name"])) {
                ...
                $custom_name = "bfourth3_" . $today.rand(10,100);
            ...
            if(isset($_FILES["b10_fourth_file"]["name"])) {
                ...
                $custom_name = "bfourth4_" . $today.rand(10,100);
            ...
            if(isset($_FILES["b10_fifth_file"]["name"])) {
                ...
                $custom_name = "bfourth5_" . $today.rand(10,100);
            ...
            if(isset($_FILES["b10_sixth_file"]["name"])) {
                ...
                $custom_name = "bfourth6_" . $today.rand(10,100);
...
//            redirect('businessFourth7');
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_6_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function business_fourth_Form7(){
...
//            print_r($this->session->userdata());die();
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_7_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function business_fourth_Form8(){
...
//                $this->session->unset_userdata('businesThird_payment_api_link');
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_8_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function business_fourth_Form9(){
...
//            print_r($this->session->userdata());die();
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_9_scr');
            $this->load->view('website/footer', $data);
        }
    }
    
    function businessFourthPaymentPage(){
...
//            print_r($data);
            $newdata = array(
                'businessFourthPaymentPage' => $data
            );
//            print_r($this->session->userdata('business1'));
            $this->session->set_userdata($newdata);
//            echo 'hello';
...
//            print_r($this->session->userdata());die();
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_payment_page_scr');
            $this->load->view('website/footer', $data);
        }
        
    }
    
    function businessFourthBadResponse(){
...
//            echo "<pre>";        print_r($data); die;
            ...
            $this->load->view('website/header');
            $this->load->view('website/businessFourth/business_fourth_bad_response',$data);
            $this->load->view('website/footer', $data);
        
        
    }
    
    function businessFourthAllFormSubmit(){
...
//            print_r($this->session->userdata());die();
            ...
            $last_name = $businessFourth1['last_name'];
            $unique_id = $businessFourth1['unique_id'];
            $hometown = $businessFourth1['hometown'];
            $street = $businessFourth1['street'];
            $home_no = $businessFourth1['home_no'];
            $client_phone = $businessFourth1['client_phone'];
            $client_phone = str_replace(["-"], '', $client_phone);
            $client_email = $businessFourth1['client_email'];
            $client_gender = $businessFourth1['client_gender'];
            $client_date_of_birth = strtr($businessFourth1['client_date_of_birth'], '/', '-');
            $client_date_of_birth = date('Y-m-d', strtotime($client_date_of_birth));
            $user_first_file = $businessFourth1['user_first_file'];

            // order id number
            $order_id_number = $this->session->userdata('order_id_number');
            
            $businessFourth2 = $this->session->userdata('businessFourth2');
            $company_name = $businessFourth2['company_name'];
            $business_type = $businessFourth2['business_type'];
            $company_id = $businessFourth2['company_id'];
            $company_address = $businessFourth2['company_address'];
            $contact_person_name = $businessFourth2['contact_person_name'];
            $contact_person_email = $businessFourth2['contact_person_email'];
            $contact_person_phone = $businessFourth2['contact_person_phone'];
            $contact_person_phone = str_replace(["-"], '', $contact_person_phone);
            
            $businessFourth3 = $this->session->userdata('businessFourth3');
//            $first_base64_signature = $businessSec3['first_base64_signature'];
//            $second_base64_signature = $businessFourth3['second_base64_signature'];
            $req_gur_amt = $businessFourth3['businessFourth_requested_gur_amount'];
            $gur_period_month = $businessFourth3['gur_period_month'];
            $startDate = $businessFourth3['startDate'];
            $endDate = $businessFourth3['endDate'];
//            $checkbox2 = $businessSec3['checkbox2'];
//            $checkbox1 = $businessSec3['checkbox1'];
//            $btn3_checkbox = $businessSec3['btn3_checkbox'];
            $value_check = $businessFourth3['value_check'];
...
//            $another_user_file = $businessThird4['another_user_file'];
            ...
            $payment_api_link = $this->session->userdata('businesFourth_payment_api_link');
            
            $businessFourth4 = $this->session->userdata('businessFourth4');
            $property_owner_name = $businessFourth4['property_owner_name'];
            $owner_of_property = $businessFourth4['owner_of_property'];
            $property_owner_phone = $businessFourth4['property_owner_phone'];
            $property_owner_phone = str_replace(["-"], '', $property_owner_phone);
            $property_owner_of_email = $businessFourth4['property_owner_of_email'];
            $property_address = $businessFourth4['property_address'];
            
            $b7_company_name = $businessFourth4['company_name'];
            $b7_company_address = $businessFourth4['company_address'];
            // $gur_period_date_range = $business7['gur_period_date_range'] ;
            // $cmpStartDate = $business7['cmpStartDate'] ;
            // $cmpSndDate = $business7['cmpSndDate'] ;
            $company_telephone = $businessFourth4['company_telephone'];
            $company_telephone = str_replace(["-"], '', $company_telephone);
            $company_email = $businessFourth4['company_email'];
            $b7_other_company_name = $businessFourth4['other_company_name'];
            $gr_company_file = $businessFourth4['gr_company_file'];
            $b7_company_id = $businessFourth4['company_id'];
            $b7_contact_id = $businessFourth4['agent_id'];

    $businessFourth6 = $this->session->userdata('businessFourth6');
    $gurantee_articles_of_association = $businessFourth6['gurantee_articles_of_association'];
    $gurantee_certificate = $businessFourth6['gurantee_certificate'];
    $gurantee_exemption_withholding_tax = $businessFourth6['gurantee_exemption_withholding_tax'];
    $gurantee_bookkeeping_authorization = $businessFourth6['gurantee_bookkeeping_authorization'];
    $gurantee_oval_attorney = $businessFourth6['gurantee_oval_attorney'];
    $gurantee_direct_debit_authorization = $businessFourth6['gurantee_direct_debit_authorization'];
...
//            die();
            ...
            if($err){
//                 echo $err;die();
                $session_array = array('businessFourth2', 'businessFourth3', 'businessFourth4', 'businessFourth5', 'businessFourth6', 'businessFourth7');
                $this->session->unset_userdata($session_array);
                echo "<script type='text/javascript'>alert('Error!'); window.location.href = '".site_url('businessFourth1')."'; </script>";
                return FALSE;
//                redirect('businessThird1');
                 ...
                 if(!empty($orderData)){
                     if($orderData->status == "true"){
                         if(empty($orderData->order_reponse_data->sfId)){
                            ...
                            $session_array = array('business1', 'business2', 'businessFourth2', 'businessFourth3', 'businessFourth4', 'businessFourth5', 'businessFourth6', 'businessFourth7');
                            $this->session->unset_userdata($session_array);
                            ...
                            if(!empty($businessFourth2)){
                                ...
                                if(!empty($business_type)){
                                    if($business_type == 'חברה בע”מ'){
                                        ...
                                        $session_array = array('businessFourth2', 'businessFourth3', 'businessFourth5', 'businessFourth6', 'businessFourth7');
                                        $this->session->unset_userdata($session_array);

                                        echo "<script type='text/javascript'>alert('Your record successfully saved!');window.location.href = '".site_url('businessFourth7')."';</script>";
                                        return FALSE;
                                        ...
                                        $session_array = array( 'businessFourth2', 'businessFourth3', 'businessFourth5', 'businessFourth6', 'businessFourth7');
                                        $this->session->unset_userdata($session_array);
                                        echo "<script type='text/javascript'>alert('Your record successfully saved!');window.location.href = '".site_url('businessFourthPaymentPage')."';</script>";
                                        return FALSE;
                                    }
                                }
                                else{
                                    
                                    $session_array = array('business1', 'business2', 'businessFourth2', 'businessFourth3', 'businessFourth5', 'businessFourth6', 'businessFourth7');
                                    $this->session->unset_userdata($session_array);
                                    echo "<script type='text/javascript'>alert('Error1!'); window.location.href = '".site_url('business1')."'; </script>";
                                    return FALSE;
                                }
                                ...
                                $session_array = array('business1', 'business2', 'businessFourth2', 'businessFourth3', 'businessFourth5', 'businessFourth6', 'businessFourth7');
                                $this->session->unset_userdata($session_array);
                                echo "<script type='text/javascript'>alert('Error2!'); window.location.href = '".site_url('business1')."'; </script>";
                                return FALSE;
                            }
...
//                 print_r($orderData); die();
    ...
    function business_payment_api() {
        $postForm = $_POST;
         ...
         $postForm['businessFourth_requested_gur_amount'] = str_replace(',', '', $postForm['businessFourth_requested_gur_amount']);
         
        
// print_r($_POST);
// echo $amount = $_POST["req_gur_amt"];
            $amount = str_replace(',', '',$_POST["businessFourth_requested_gur_amount"]);
            $amount = $amount*0.06;
            ...
            $first_name = $businessFourth1['first_name'];
            $last_name = $businessFourth1['last_name'];
            $TZId = $businessFourth1['unique_id'];
            $street = $businessFourth1['street'];
            $home_no = $businessFourth1['home_no'];
            $client_gender = $businessFourth1['client_gender'];
...
//            die();
            ...
            //die();
            $newdata = array(
                'businessFourth3' => $postForm
            );
//            print_r($this->session->userdata('business1'));
            $this->session->set_userdata($newdata);
            
            $api_data = array("OrgId" => 10069,"FirstName" => "$first_name","LastName" => "$last_name","TZ" => "$TZId","Cell" => "$client_phone","Email"=> "$client_email","Street" => "$street","HouseNum"=> "$home_no","City" => "תל אביב","Sex" => $client_gender,"Birthdate_y" => "$client_year","Birthdate_m" => "$client_month","Birthdate_d" => "$client_day","Amount" => $amount ,"Duration" => $diff,"Product" => "מימון עמלה","OrderId" => "14XA24F","SuccessUrl" => "https://obli.co.il/business4PaymentSuccess","FailureUrl" => "https://obli.co.il/business4PaymentFailed","AutoApprove"=> 0);
...
//            print_r($api_data);
            ...
            curl_setopt_array($curl, array(
              ...
              CURLOPT_POSTFIELDS => "{\n\"OrgId\" : 10069,\n\"FirstName\" : \"$first_name\",\n\"LastName\" : \"$last_name\",\n\"TZ\" : \"$TZId\",\n\"Cell\" : \"$client_phone\",\n\"Email\": \"$client_email\",\n\"Street\" : \"$street\",\n\"HouseNum\": \"$home_no\",\n\"City\" : \"תל אביב\",\n\"Sex\" : $client_gender,\n\"Birthdate_y\" : \"$client_year\",\n\"Birthdate_m\" : \"$client_month\",\n\"Birthdate_d\" : \"$client_day\",\n\"Amount\" : $amount ,\n\"Duration\" : $diff,\n\"Product\" : \"מימון עמלה\",\n\"OrderId\" : \"14XA24F\",\n\"SuccessUrl\" : \"https://obli.co.il/business4PaymentSuccess\",\n\"FailureUrl\" : \"https://obli.co.il/business4PaymentFailed\",\n\"AutoApprove\": 0\n}",
            ...
            if ($err) {
                ...
                $log_data = array('tz_id' => $TZId, 'firstname' => $first_name, 'lastname' => $last_name, 'form_text' => 'Business Fourth', 'payment_url' => $this->config->item('payment_url'), 'request_data' => json_encode($api_data), 'error_data' => $err, 'created_at' => date('Y-m-d H:i:s') );
...
//              $form_data['data'] = array('status' => 'false');
                ...
                // log error insert in table
                $log_data = array('tz_id' => $TZId, 'firstname' => $first_name, 'lastname' => $last_name, 'form_text' => 'Business Fourth', 'payment_url' => $this->config->item('payment_url'), 'request_data' => json_encode($api_data), 'response_data' => $response, 'created_at' => date('Y-m-d H:i:s') );
                 $this->project_model->insert_data('check_payment_api_response', $log_data);
                // end 
...
//                    echo $res->iframe->mpiHostedPageUrl;
                    $this->session->set_userdata(array(
                      'businesFourth_payment_api_link' => $res->iframe->mpiHostedPageUrl
                  ));
...
//            print_r($this->session->userdata('business1'));
    ...
    function business4PaymentSuccess(){
        $data = array();
        if(!empty($_REQUEST)){
//        echo '<pre>';
//        print_r($_REQUEST);
    ...
    function business4PaymentFailed(){
        $data = array();
        if(!empty($_REQUEST)){
//        echo '<pre>';
//        print_r($_REQUEST);
