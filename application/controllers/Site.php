   ...
   <div class="col-md-1"></div>         
    ...
    <div class="row form_position">
       ...
       <div class="col-md-1"></div>
        ...
        $final_pdf_path = $this->pdf1($html, $pdf_location);
        echo '<pre>';
      ...
      <table STYLE="width:100%;">
        <tr>
            ...
            <OL>
                ...
                <LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL"> אנו ערבים בזה כלפיך/ם לתשלום כל סכום עד לסכום כולל של <B><U>'.$amount.'</B></U> ₪ (להלן: "סכום הערבות") שתדרוש/תדרשו מאת <B><U>'.$companyName.'</B></U>  ת.ז <B><U>'.$clientID.'</B></U> (להלן וביחד: "הנערב") בקשר עם ההסכם מיום <B><U>'.$date.'</B></U>, על כל תוספותיו, ככל שיהיו מעת לעת (להלן: <B>"ההסכם"</B>).
 </SPAN></FONT></P>
...
<p style="margin: 30px 40px 0px 0px;text-align: center;">
 ...
 // House Rent Document //
   ...
   $signaturepath = 'https://obli.co.il/website_assets/img/sign_1.png';
     ...
     <!-- <table STYLE="width:100%;">
        <tr>
            ...
            <OL>
                ...
                <LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL"> אנו ערבים בזה כלפיך/ם לתשלום כל סכום עד לסכום כולל של <B><U>'.$amount.'</U></B> ₪ (להלן: "סכום הערבות") שתדרוש/תדרשו מאת <B><U>'.$companyName.'</U></B>  ת.ז <B><U>'.$company_id_change.'</U></B> (להלן וביחד: "הנערב") בקשר עם ההסכם מיום <B><U>'.$date.'</U></B>, על כל תוספותיו, ככל שיהיו מעת לעת (להלן: <B>"ההסכם"</B>).
 </SPAN></FONT></P>
