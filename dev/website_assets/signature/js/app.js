...
// end second signature

// third signature pad
var wrapper3 = document.getElementById("signature-pad-3");
var clearButtonCanvas3 = wrapper3.querySelector("[data-action=clear3]");
...
//       }
   ...
   if(isMobile){
        ...
        // third clear canvas
        $(".new_scr_third_modal").css("opacity","0.5");
        $(".new_scr_third_modal").css("cursor","auto");
   }
    ...
    // third clear canvas
    $("#new_sec_scr_checkbox3").hide();
    $("#new_btn3_checkbox").prop("checked", false);
...
// clear canvas 3
if(clearButtonCanvas3){
 clearButtonCanvas3.addEventListener("click", function (event) {
   signaturePad3.clear();
...
//        }
  ...
  // new signature popup button check
  if($("#second_bae64_sign").val() != '' && $("#third_bae64_sign").val() != ''){

      $(".new_scr_third_modal").css("opacity","1");
      $(".new_scr_third_modal").css("cursor","pointer");
...
// end canvas signature 2

// start canvas signature 3
// second signature generate
var handlefocus3=function(e){
  if(e.type=='mouseover'){
  console.log("focus");
  ...
  if($("#second_bae64_sign").val() != '' && $("#third_bae64_sign").val() != ''){
    ...
    if(isMobile){
      ...
      // (Business first form screen)
     if($("#req_gur_amt").val() != '' && $("#gur_period_month").val() != '' && $('#checkbox3').is(":checked") && $('#checkbox4').is(":checked") != '' && $("#first_bae64_sign").val() != ''  ){
     ...
     // business third form screen
        if($("#busineesThird_requested_gurantee_amt").val() != '' && $("#gur_period_month").val() != '' && $("#first_bae64_sign").val() != '' && $("#second_bae64_sign").val() != '' ){
...
canvas3.addEventListener('mouseout',handlefocus3,false);
