...
class Admin extends CI_Controller {
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                    ...
                    if ($front_obli_id > 0) {
                        ...
                        redirect('index.php/admin/edit_front_ui/'.$front_obli_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_front_ui");
                    }
        ...
        $ch = array("main_title" => $this->input->post("main_title"), "id !="=> $front_obli_id);
            ...
            if (!empty($front_obli_id)) {
                ...
                if (!empty($admin_detail)) {
                    ...
                    redirect('index.php/admin/add_front_ui');
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                    ...
                    if ($coming_soon_id > 0) {
                        ...
                        $this->session->set_flashdata('success', 'Record added successfully.');
                        redirect('index.php/admin/edit_coming_soon/'.$coming_soon_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_coming_soon");
                    }
        ...
        $ch = array("coming_soon_title" => $this->input->post("coming_soon_title"), "id !="=> $coming_soon_id);
            ...
            if (!empty($coming_soon_id)) {
                ...
                if (!empty($admin_detail)) {
                    ...
                    redirect('index.php/admin/add_coming_soon');
    ...
    function add_banner()
    {
        if ($this->input->post())
        {
            ...
            $data['sub_title'] = $data['new_title'];
             
             unset($data['new_title']);
            ...
            if (empty($rec)) {
                    ...
                    if ($banner_id > 0) {
                        ...
                        redirect('index.php/admin/edit_banner/'.$banner_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_banner");
                    }
    ...
    function add_section_2()
    {
        if ($this->input->post())
        {
            ...
            $data['first_sub_title_text'] = $data['new_title_text_first'];
            
            unset($data['new_title_text_first']);
            
            
             $data['second_sub_title_text'] = $data['new_title_text_second'];
            
            unset($data['new_title_text_second']);
            ...
            if (empty($rec)) {
                    ...
                    if ($section2_id > 0) {
                        ...
                        redirect('index.php/admin/edit_section_2/'.$section2_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_section_2");
                    }
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                    ...
                    if ($testmonial_id > 0) {
                        ...
                        redirect('index.php/admin/edit_section_3/'.$testmonial_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_section_3");
                    }
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                    ...
                    if ($section4_id > 0) {
                        ...
                        $this->session->set_flashdata('success', 'Details added successfully.');
                        redirect('index.php/admin/edit_section_4/'.$section4_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_section_4");
                    }
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                    ...
                    if ($section5_id > 0) {
                        ...
                        $this->session->set_flashdata('success', 'Details added successfully.');
                        redirect('index.php/admin/edit_section_5/'.$section5_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_section_5");
                    }
            ...
            if (empty($rec)) {
                ...
                if (empty($rec1)) {
                    ...
                    if ($menu_id > 0) {
                        ...
                        redirect('index.php/admin/edit_menu/'.$menu_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_menu");
                    }
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                ...
                if ($icon_id > 0) {
                    ...
                    redirect('index.php/admin/edit_icon/'.$icon_id);
                    
                } else {

                    $this->session->set_flashdata('error', 'Error in insertion');
                    redirect("index.php/admin/edit_icon");
                }    
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                    ...
                    if ($app_link_id > 0) {
                        ...
                        redirect('index.php/admin/edit_app_url/'.$app_link_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_app_url");
                    }
        ...
        if ($this->input->post())
        {
            ...
            if (empty($rec)) {
                    ...
                    if ($aboutus_id > 0) {
                        ...
                        $this->session->set_flashdata('success', 'Banner details added successfully.');
                        redirect('index.php/admin/edit_aboutus/'.$aboutus_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_aboutus");
                    }
...
//                if (empty($rec1)) {
                    ...
                    if ($cmp_id > 0) {
                        ...
                        redirect('index.php/admin/edit_company/'.$cmp_id);
                        
                    } else {

                        $this->session->set_flashdata('error', 'Error in insertion');
                        redirect("index.php/admin/edit_company");
                    }
    ...
    function delete() {
        ...
        if ($delete == TRUE) {
            ...
            if ($delete_type == 'delete_agent') {
                ...
                redirect('index.php/admin/agent_list');
            ...
            if ($delete_type == 'delete_testimonial') {
                ...
                redirect('index.php/admin/testmonial_section_3');
            ...
            if ($delete_type == 'delete_menu') {
                ...
                redirect('index.php/admin/menu_list');
            ...
            if ($delete_type == 'delete_icons') {
                ...
                redirect('index.php/admin/icon_list');
    ...
    function change_pass() {
        ...
        if ($this->input->post('old_pass')) {
            ...
            if ($check_user) {
                ...
                redirect('index.php/change-password');
