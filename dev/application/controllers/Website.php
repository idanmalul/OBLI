...
class Website extends CI_Controller {
  ...
  function userdashboard(){
    ...
    function pdf1($html,$pdf_location){
        // $file_path = base_url() . "doc_sign/5de0fb3a5b6d21223182045.png";
        // echo $file_path; die();
        // $path = base_url(). 'webservices/vendor/autoload.php';
        $pdfData = array();
        ...
        $mpdf = new \Mpdf\Mpdf(['mode' => 'utf-8']);
            ...
            // Set some flags for mPDF- this function use for only hindi language
            ...
            // $bootstrap_min_css =  '<style>'.file_get_contents('assets/pdf_assets/external/bootstrap.min.css').'</style>';
            // $slim_min_js = '<script>'.file_get_contents('assets/pdf_assets/external/slim.min.js').'</script>';
            // $popper_min_js = '<script>'.file_get_contents('assets/pdf_assets/external/popper.min.js').'</script>';
            // $bootstrap_min_js = '<script>'.file_get_contents('assets/pdf_assets/external/bootstrap.min.js').'</script>';
            // $style_css = '<style>'.file_get_contents('assets/pdf_assets/css/style1.css').'</style>';

            // $html = file_get_contents('assets/pdf_assets/external/header.php');

            // echo $html; die();
            // apply external css
            // $mpdf->WriteHTML($bootstrap_min_css,1);
            // $mpdf->WriteHTML($slim_min_js,1);
            // $mpdf->WriteHTML($popper_min_js,1);
            // $mpdf->WriteHTML($style_css,1);
    ...
    function test_pdf1(){
        $fathers_var = "Father's / Husband's";
...
<body>
    <div class="container background_box" style="border: 1px solid black; padding: 5px;">
        <div class="row">
        
            <div class="col-md-2 col-sm-2"><img class="img_logo0" src="'.base_url().'assets/pdf_assets/img/koutilya.png"></div>
            <div class="col-md-8 col-sm-8">
            <div style="color:#39337a; text-align: center; padding: 30px;">
             <span class="head_text">प्रदेश का न.1 संस्थान </span>
                  <h2 class="text00">इंदौर कौटिल्य एकेडमी</h2> 
                  <p class="text01">
                 AN ISO 9001 : 2015 CERTIFIED INSTITUTE OF आपकी सफलता का प्रवेश द्वार.... <br></p>
                 <div class="boder_01"></div>
            </div>
             
            </div>
            <div class="col-md-2 col-sm-2"><img class="img_logo01" src="'.base_url().'assets/pdf_assets/img/koutilya.png"></div>
        ...
        <div class="row">
            ...
            <div class="col-md-10">
            <div class="box00">ADMISSION FORM</div>
            <div class="box001">CLASSES FOR : IAS, IPS, MPPSC, MPSI, SSC, BANK & OTHER COMPETITIVE EXAMS</div>
         <div style="color:#39337a; text-align: center;">
                 
                  <p class="text3">
                  36, Siddharth Nagar, Dawar Regency, Bhanwarkua Square, Indore, 0731-4971711, 9111100925 <br>
                  HEAD OFFICE : RAJWADA CHOWK, INDORE : 0731-4083933, 9111100925 <br>
    ...
    <form style="margin-top: 15px; color: #39337a;">
        ...
        <div class="row">
           ...
           <div class="col-md-5">
            ...
            <div class="col-md-3 field-label-responsive">
                <label for="name">Roll No. :<br>अनुक्रमांक</label>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <div class="input-group">
                       <input type="text" class="form-control form-control0" placeholder="" >
                    </div>
                </div>
            </div>
           </div>
        ...
        <div class="row">
           ...
           <div class="col-md-2" style="height: 200px; border: 1px solid;">
             <img class="img_user" src="'.base_url().'assets/pdf_assets/img/user-icon-silhouette.jpg">
           </div>
           <div class="col-md-1"></div>
          
        </div>

       <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-3 field-label-responsive">
                <label for="name">Name (In Capital Letters)<br>नाम</label>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <div class="input-group">
        ...
        <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-3 field-label-responsive">
                <label for="name">'.$fathers_var.' Name<br>पिता / पति का नाम</label>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <div class="input-group">
        ...
        <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-3 field-label-responsive">
                <label for="name">'.$fathers_var.' Occupation<br>पिता  / पति का व्यवसाय</label>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <div class="input-group">
        ...
        <div class="row form_position">
           ...
           <div class="col-md-2 field-label-responsive">
                <label for="name">Email ID<br>ईमेल आईडी</label>
            </div>
            <div class="col-md-2" style="position: relative; right: 5%;">
                <div class="form-group">
                    <div class="input-group">
                       <input type="text" class="form-control form-control0" placeholder="" >
                    </div>
            ...
            <div class="col-md-2 field-label-responsive" style="position: relative; left: 7%;">
                <label for="name">Mob.<br>मो. न.</label>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
         ...
         <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-3 field-label-responsive">
                <label for="name">Permanent Address<br>स्थाई पता</label>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <div class="input-group">
       ...
       <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-3 field-label-responsive">
                <label for="name">Present Address<br>वर्तमान पता</label>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <div class="input-group">
        ...
        <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-3 field-label-responsive">
                <label for="name">whatsapp No<br>व्हाट्सएप नं</label>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <div class="input-group">
        ...
        <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-2 field-label-responsive">
                <label for="name">Pin Code<br>पिन कोड</label>
            </div>
            <div class="col-md-2" style="position: relative; right: 5%;">
                <div class="form-group">
                    <div class="input-group">
            ...
            <div class="col-md-2 field-label-responsive" style="position: relative; left: 7%;">
                <label for="name">Ph. (Guardian)<br>पालक का मो. न.</label>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
        ...
        <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-2 field-label-responsive">
                <label for="name">Date of Birth<br>जन्म तारीख</label>
            </div>
            <div class="col-md-2" style="position: relative; right: 5%;">
                <div class="form-group">
                    <div class="input-group">
            ...
            <div class="col-md-2 field-label-responsive" style="position: relative; right: 5%;" >
                <div>
                  <label for="color-1">
                  Male<br>पुरुष
                  </label>
                ...
                <div style="position: relative; top: -50%; left: 65%;">
                  <label for="color-2">
                   Female<br>महिला
                  </label>
            ...
            <div class="col-md-4" style="position: relative; right: 2%;">
                <div class="form-group">
                   Category : Gen/SC/ST/OBC <br>श्रेणी: जनरल / एससी / एसटी / ओबीसी
                </div>
            </div>
          <div class="col-md-1"></div>
     ...
     <div class="col-md-1"></div>
      <div class="col-md-10">
     <table class="table table-bordered form_position table">
    <thead>
      <tr style="background: #39337a; color: white; text-align: center;">
        <th>बोर्ड / विश्व विद्यालय</th>
        <th>उत्तीर्ण परीक्षा</th>
        <th>वर्ष</th>
        <th>% of Marks Obtained<br>प्राप्तांक प्रतिशत</th>
      </tr>
    </thead>
    <tbody>
...
<form style="color: #39337a;">

  <div class="row form_position">
           <div class="col-md-1"></div>
           <div class="col-md-3 field-label-responsive">
                <label for="name">Academic Distinction if any<br>शैक्षणिक योग्यता</label>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
            ...
            <div class="col-md-3 field-label-responsive" style="position: relative; left: 7%;">
                <label for="name">Hobby<br>अभिरुचि</label>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
          ...
          <div class="row form_position">
           ...
           <div class="col-md-4 field-label-responsive">
                <label for="name">Course/Class in which admission is requested<br>कोर्स / कक्षा जिसमें प्रवेश का अनुरोध किया जाता है</label>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
            ...
            <div class="col-md-2 field-label-responsive" style="position: relative; left: 7%;">
                <label for="name">Medium<br>माध्यम</label>
            </div>
            <div class="col-md-2">
                <div class="form-group">
                    <div class="input-group">
  ...
  <div class="col-md-10">
      ...
      <p class="box_p">I Hereby declare that the information given above is true to the best of my knowledge and belief.<br>मैं प्रमाणित करता/करती हूँ कि ऊपर दी गई जानकारी पूर्णतः सत्य है।  </p>
      <p class="box_p">I have read the rules & regulations given below & will abide by them.<br>नीचे दिये गये सारे दिशा निर्देशो को मेरे द्वारा पालन किया जायेगा।  </p>
      <p class="box_p">I agree in any case fee should not be refunded of adjusted.<br>मै सहमत हूँ की किसी भी स्थिति में मेरा शुल्क समायोजित और प्रतिदाय नहीं किया जायेगा।</p>
         
      <div class="border_line-text">  
       
      </div>
      <p class="box_p1">Rules & Regulations / नियम व शते </p>
     
       <p class="box_p">1. संस्थान के किसी भी कोर्स में दाखिला / प्रवेश लेने पर संस्थान के सारे दिशा निर्देशो का पालन अनिवार्य होगा। <br>All student who admitted to any course in the Institute are expected to abide by the rules & regulations.</p>
       <p class="box_p">2. सभी विद्यार्थी कक्षा के अन्दर और बाहर अनुशासन बनाये रखेंगे। <br>Every student is expected to maintain discipline in and outside the classroom.</p>
       <p class="box_p">3. समय सारणी और स्थल में किये जाने वाले किसी भी बदलाव का अधिकार संस्था के पास होगा। <br>The Institute reservesthe right to change the timetable or venue of holding classes at any time.</p>
       <p class="box_p">4. विद्यार्थी की छायाचित्र संलग्न करना अनिवार्य हैं  संस्थान अपने प्रचार प्रसार हेतु छायाचित्र उपयोग कर सकता हैं। <br>The photograph of student is complusory and can be used by the institute for publicity.</p>
       <p class="box_p">5. उन्हीं बच्चों की फीस कुछ सीमा तक संस्था के स्वविवेक नियमों के आधार पर वापस होगी जो बच्चे एकमुश्त फीस जमा करते है ,  इंस्ट्रोलमेंट आधार पर जमा की गई फीस वापस नहीं होगी। <br>Those student who have paid lump sum fee, academy will refund their fee only, fee paid in installment will not be refunded.</p>
       <p class="box_p">6. यदि आप ( UG के विद्यार्थी  ) एक वर्ष के भीतर ही एकेडमी छोड़ते है तो उस स्थिति में एकडेमी आपके कॉलेज संबंधी किसी भी प्रकार की गतिविधि के प्रति जबाबदार नहीं होगी।  <br> If UG student leaves academy within 1 year therefore academy will not be responsible for any activity related to college.</p> 
       <p class="box_p">7. तीन वर्षीय पाठ्यक्रम के विद्यार्थियों को 18 माह में पूरी फीस जमा करना अनिवार्य है। <br> UG student is compulsive to pay the coaching fess within 18 months.</p>
       <p class="box_p">8. तीन वर्ष के पाठ्यक्रम में कॉलेज चेंज नहीं होगा।  यदि आपको किसी प्रकार की समस्या भी है तो फीस और कॉलेज फीस के संबंध में कोई बात स्वीकार नहीं की जायेगी। <br> UG student is not allowed to change the college and in case he/she face any problem regarding college therefore academy will not take any responsibility related to college & coaching fee. </p>
       <p class="box_p">9. एडमिशन लेने के पश्चात् यदि किसी उचित कारण से फीस वापस करनी पड़ी तो उसमें कुल जमा फीस का   एवं बैंकिंग चार्ज (18+2=20%) रजिस्ट्रेशन फीस , मार्केटिंग , एडमिशन प्रोसेस 10000 रूपये एवं नोट्स , बैग एवं ड्रेस का चार्ज 10000 रुपये साथ ही एक व्यक्ति जितने माह पढ़ चुका है उस अनुपात में फीस घटा कर  दी जायेगी। फोटोकॉपी , टेस्ट पेपर चार्ज प्रतिमाह 1000 रुपये भी घटाया जायेगा <br>After taking admission if student want to take admission back therefore gst & banking charges (18+2=20%) registration, marketing, admission process charge 10000, notes , bag & dress charge 10000, photocopy, test paper 1000 per month & line number of months he/she studies will all be deduction & rest of the fess will be refunded. </p>
       <p class="box_p">10. संबंधित व्यक्ति को अस्वस्थ होने पर जिला अस्पताल के मुख्य चिकित्सा अधिकारी का प्रमाणपत्र , ट्रांसफर होने पर ट्रांसफर लेटर भी देना होगा। साथ ही स्टाम्प पेपर में एडमिशन वापस लेने का कारण भी लिखकर रजिस्टर्ड कराकर देना होगा। <br> Is student is not well and wants to take admission back he/she has to show the certificate of the government hospital & if he/she is working & perparing for exam in coaching and wants to take transfer so he/she has to show the transfer certificate attested from gazetted officer and also has to right the reason for leaving coaching in a stem ppaper. </p>
       <p class="box_p">11. फीस जमा करने की नियत तारीख में यदि जमा फीस नहीं होती तो 50 रुपये प्रतिदिन लेट फीस लगेगी। <br> If fee is not paid in given time therefore 50 rupees per days will be charged. </p>
       <p class="box_p">12. कॉलेज एवं कोचिंग के संबंध में सभी बच्चों का 100 रुपये के स्टाम्प पेपर में एग्रीमेंट होगा <br>Regarding college & coaching every student is compulsive for the agreement of 100 rupees stemp  paper.</p>
 ...
 <div class="row form_position">
   ...
   <div class="">
                <label for="name">Signature of the Student<br>विद्यार्थी के हस्ताक्षर</label>
  </div>
   <div class="col-md-1"></div>         
    ...
    <div class="row form_position">
       <div class="col-md-1"></div>
       <div class="col-md-10" style="border-bottom: 1px solid #39337a;"></div>
       <div class="col-md-1"></div>
    </div>
        ...
        $pdf_location = "uploads/student_receipt_pdf/";
        $final_pdf_path = $this->pdf1($html, $pdf_location,2);
        echo '<pre>';
    ...
    function test_pdf()
    {
        ...
        $file_path = base_url() . "doc_sign/5e00b35b9d5c5.png";
        $html = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
           ...
           <div STYLE="margin-left:10%; margin-right:10%; width:80%;">
            ...
            <P DIR="RTL" CLASS="western" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%">
                    ...
                    <FONT FACE="David"><SPAN LANG="he-IL"><B><U>'.$name.'</U></B></SPAN></FONT>
                    <br/>
                    <br/>
                    <FONT FACE="David"><SPAN LANG="he-IL"><B><U>'.$address.'</U></B></SPAN></FONT>
      ...
      <table STYLE="width:100%;">
        <tr>
            ...
            <LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL"> אנו ערבים בזה כלפיך/ם לתשלום כל סכום עד לסכום כולל של <B><U>'.$amount.'</U></B> ₪ (להלן: "סכום הערבות") שתדרוש/תדרשו מאת <B><U>'.$companyName.'</U></B>  ת.ז <B><U>'.$company_id_change.'</U></B> (להלן וביחד: "הנערב") בקשר עם ההסכם מיום <B><U>'.$startDate.'</U></B>, על כל תוספותיו, ככל שיהיו מעת לעת (להלן: <B>"ההסכם"</B>).
...
<B>"המדד היסודי"</B> לעניין ערבות זו, יהא המדד שפורסם בגין חודש '.date("m").' שנה '.date("Y").'.
...
//                    echo "123_test"; die();
                    ...
                    $this->session->set_flashdata('success', 'ההודעה נשלחה בהצלחה !');
                    redirect('contactus');
                }else{
...
//            print_r($this->session->userdata('business1'));
        ...
        // first signature image start
            define('UPLOAD_DIR', 'doc_sign/');
             ...
             $file_path11 = $_SERVER["DOCUMENT_ROOT"].'/'.$file1; 
              // $file_path1 = "222";
        ...
        // second signature image start
            define('UPLOAD_SECOND_DIR', 'doc_sign/');
              ...
              $file_path22 = $_SERVER["DOCUMENT_ROOT"].'/'.$file2; 
              // $file_path2 = "123";
...
צורך בדיקת הבקשה, אנחנו מתכוונים לפנות ללשכת אשראי על מנת לקבל חיווי אשראי. מובהר בזאת שלצורך קבלת החיווי לשכת האשראי תגיש בקשה לבנק ישראל לקבלת נתוני אשראי לגביך הכלולים במאגר. הפנייה ללשכת אשראי לצורך קבלת חיווי הינה בכל מקרה של בקשה לקבלת הלוואה באמצעות טריא. </SPAN></FONT></P>
          ...
          <P DIR="RTL" CLASS="western text_color" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%; text-align:center; ">
            ...
            <img src="'.$file_path11.'" class="img-responsive" style="margin-left: 20px;">
...
ו/או אינו הוגדר כלקוח מוגבל חמור.בהתאם לסעיף 3 ... </SPAN></FONT></P>
            ...
            <img src="'.$file_path22.'" class="img-responsive" style="margin-left: 20px;">
...
//            echo 'hello';
           // print_r($this->session->userdata()); die();
            ...
            $session_array = array('business1', 'business2', 'business3', 'business4', 'business5', 'business6', 'business7', 'business8', 'business9', 'business10', 'business11','propertyownerData');
...
//            print_r($data);
        ...
        // New API for insert each form on SF //
           ...
           $business3 = $this->session->userdata('business3');
            ...
            if($business_type == 'חברה בע”מ'){
              ...
              $business_type  = 'business ltd';
            }else{
                
                $business_type  = 'licensed dealer';
                
            }
        
        $fields = array("Business_Field__c"=>$Business_Field__c,"Area__c"=>$Area__c,"amt_company_name__c" => $company_name,
            "amt_company_address__c" => $company_address, "amt_company_id__c" => $company_id, "amt_company_business_type__c" => $business_type,
            "amt_company_contact_person_email__c" => $contact_person_email, "amt_company_contact_person_name__c" => $contact_person_name, 
            "amt_company_contact_person_phone__c" => $contact_person_phone,'order_id_number__c' => $order_id_number,'flow_number__c'=>3,'client_id_number'=>$unique_id,
            'ref_client_id__c'=>$unique_id,'form_type_in_text__c'=>'Business','client_first_name__c'=>$first_name,
            'client_last_name__c'=>$last_name,'flow_type__c'=>1,'form_type__c'=>2);
...
//             die();
     ...
     //end of New API for insert each form on SF //
...
//            print_r($this->session->userdata());die();
    ...
    function business_Form5(){
         ...
         $this->session->set_userdata('flow_number__c','3');
...
//            echo '<pre>';
        ...
        $prevousnfo = $this->session->userdata('business4');
        ...
        $order_id_number = $this->session->userdata('order_id_number');
           ...
           $business3 = $this->session->userdata('business3');
            ...
            $fields = array( "another_compnay_first_name__c" => $ant_first_name, "another_compnay_last_name__c" => $ant_last_name, "another_compnay_id__c" => $ant_unique_id,
             ...
             'order_id_number__c' => $order_id_number,'client_id_number'=>$unique_id,'Client__c'=>$prevousnfo['client_c'],'Annual_fee__c'=>6.5);
...
//            echo '<pre>';
           ...
           $business3 = $this->session->userdata('business3');
            ...
            $b7_company_name = $data['company_name'];
            $b7_company_address = $data['company_address'];
            ...
            $gr_company_file = $data['gr_company_file'];
            $b7_company_id = $data['company_id'];
            $b7_contact_id = $data['agent_id'];
            $b7_other_company_name = $data['other_company_name'];
            
             $fields = array("gr_company_name__c"=> $b7_company_name ,"gr_company_url__c" => $gr_company_file, 'order_id_number__c' => $order_id_number,'flow_number__c'=>3,'client_id_number'=>$unique_id,'Client__c'=>$prevousnfo['client_c']);
            
            if(!empty($b7_other_company_name)){
                $fields['gr_other_company_name__c'] = $b7_other_company_name;
            }
            
             if(!empty($b7_company_id)){
                $fields['gr_company_id__c'] = $b7_other_company_name;
            }
            
             if(!empty($company_telephone)){
                $fields['gr_company_phone__c'] = $company_telephone;
            }
            
             if(!empty($company_email)){
                $fields['gr_company_email__c'] = $company_email;
            }
            
             if(!empty($b7_contact_id)){
                $fields['gr_contact_id__c'] = $b7_contact_id;
            }
            
            if(!empty($b7_company_address)){
                $fields['gr_company_address__c'] = $b7_company_address;
            }
           ...
           // print_r($fields);
            ...
            $name_company_indivisual = explode('_',$data['company_name']);
            
            $data['name_company_indivisual'] = $name_company_indivisual[0];
...
if($is_approved == 2){
    ...
    redirect('businessFirstBadResponse');
...
//            redirect('business9');
           ...
           $business3 = $this->session->userdata('business3');
            ...
            $dataarray = array('amount'=>'','fname'=>$first_name,'lname'=>$last_name,'uniqueid'=>$unique_id,'order_id_number'=>$order_id_number);
...
<soap:Envelope xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:soap="http://schemas.xmlsoap.org/soap/envelope/">
  <soap:Body><DoBusinessProcess xmlns="http://tempuri.org/"><req>' . htmlspecialchars($request) . '</req></DoBusinessProcess></soap:Body></soap:Envelope>';
            ...
            $this->load->view('website/header');
            $this->load->view('website/business_8_scr',$data1);
            $this->load->view('website/footer', $data);
        }
    }
...
//            print_r($business6); 
        ...
        // third signature image start
            define('UPLOAD_THIRD_DIR', 'doc_sign/');
              ...
              $third_signature_file = base_url().$file3;
               ...
               $third_signature_file1 = $_SERVER["DOCUMENT_ROOT"].'/'.$file3; 
              // $file_path2 = "123";
        ...
        // user pdf and link generate (pdf details)
            ...
            $file_path = $first_signature_file1;
            $document_id = "";
            ...
            $companyName = $business4['company_name'];
...
<p style="margin: 30px 40px 0px 0px;text-align: center;">
        ...
        // second document
            ...
            <FONT FACE="David"><SPAN LANG="he-IL"> 2.3. במקרה של מימוש כתב הערבות ע"י המוטב, יוכל החייב, על פי שיקול דעתו, להשתמש בהפניית הערב  </SPAN></FONT></P>
             ...
             <P DIR="RTL" CLASS="western text_color" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%">
            <FONT FACE="David"><SPAN LANG="he-IL"> לקבלת הלוואה דרך חברת טריא בריבית שנתית קבועה של 6.5% ההלוואה תעמוד לתקופה של 18 חודשים.  </SPAN></FONT></P>
            ...
            <img src="'.$third_signature_file1.'" class="img-responsive" style="margin-left: 20px;">
 ...
 // House Rent Document //
   ...
   $propertyowner = $this->session->userdata('propertyownerData');
          
          if(!empty($propertyownerData))
          {
              $prop_owner_name = $postData['ant_first_name'].' '.$postData['ant_last_name'];
                
              $prop_owner_add = $postData['ant_client_add'];
          }else{
              $prop_owner_name = $name;
                
              $prop_owner_add = $address;
          }
   
            
   $partner_company = explode("_",$b7_company_name);
        
        $partner_company_name = $partner_company[0];
        
        $partner_company_address = $b7_company_address;
        
        
        $company_id_change = $clientID;
        
        if(!empty($company_id))
        {
            $company_id_change = $company_id;
        }
       ...
       $html = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
           ...
           <div STYLE="margin-left:10%; margin-right:10%; width:80%;">
            ...
            <P DIR="RTL" CLASS="western" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%">
                    ...
                    <FONT FACE="David"><SPAN LANG="he-IL"><B><U>'.$partner_company_name.'</U></B></SPAN></FONT>';
       
       if(!empty($partner_company_address))
       {
       
       $html .='<br/>
                    <br/>
                    <FONT FACE="David"><SPAN LANG="he-IL"><B><U>'.$partner_company_address.'</U></B></SPAN></FONT>';
       }
       
                    
                
       $html .=     '<P DIR="RTL" CLASS="western" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%">
...
<LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">סכום הערבות יהיה צמוד למדד המחירים לצרכן כפי שהוא מתפרסם מפעם לפעם על ידי הלשכה     המרכזית לסטטיסטיקה ולמחקר כלכלי, בתנאי ההצמדה שלהלן:
...
כל דרישה על פי ערבות זו צריכה להתקבל על ידינו בכתב ולא יאוחר מהתאריך הנ"ל.
 ...
 // End of house rent document //
           ...
           /*  $fields = array("client_id_number" => $unique_id, "guarantee_type" => $guarantee_type, "preferred_route" => $preferred_route, "client_first_name" => $first_name,
             "client_last_name" => $last_name, "guarantee_period_month" => $gur_period_month, "requested_amount" => $req_gur_amt, "first_signature_file" => $first_signature_file,
             "second_signature_file" => $second_signature_file, "amt_company_name" => $company_name, "amt_company_address" => $company_address, 
             "amt_company_id" => $company_id, "amt_company_business_type" => $business_text_eng, "amt_company_contact_person_email" => $contact_person_email,
             "amt_company_contact_person_name" => $contact_person_name, "amt_company_contact_person_phone" => $contact_person_phone, "ant_first_name" => $ant_first_name, 
             "ant_last_name" => $ant_last_name, "ant_unique_id" => $ant_unique_id, "ant_client_email" => $ant_client_email, "ant_client_phone" => $ant_client_phone, 
             
             "ant_client_add" => $ant_client_add, "ant_req_gur_amt" => $ant_req_gur_amt, "ant_client_gender" => $ant_client_gender, 
             "ant_account_birth_date" => $antsec_date_of_birth, "ant_lease_period" => $ant_lease_period, "ant_client_file" => $ant_client_file,
             "gr_company_name" => $b7_company_name, "gr_company_address" => $b7_company_address, "gr_company_email" => $company_email, "user_pdf" => $user_pdf,
             "gr_company_phone" => $company_telephone, "gr_company_url" => $gr_company_url, "gurantee_articles_of_association" => $gurantee_articles_of_association, 
             "gurantee_certificate" => $gurantee_certificate, "gurantee_exemption_withholding_tax" => $gurantee_exemption_withholding_tax,
             "gurantee_bookkeeping_authorization" => $gurantee_bookkeeping_authorization, "gurantee_oval_attorney" => $gurantee_oval_attorney, "user_link" => $user_link,
             "first_document" => $first_document, "second_document" => $second_document, "b7_company_id" => $b7_company_id, "b7_contact_id" => $b7_contact_id, 
             "guarantee_period_start_date" => $startDate, "guarantee_period_end_date" => $endDate, "another_guarantee_period_start_date" => $antstartDate, 
             "another_guarantee_period_end_date" => $antendDate, "gurantee_direct_debit_authorization" => $gurantee_direct_debit_authorization,
             "gr_other_company_name"=>$b7_other_company_name, 'order_id_number' => $order_id_number,"house_rent_document"=>$house_rent_document,
             'tuplier_dradit' => $tuplier_dradit);*/
              ...
              $unique_id = $business3['unique_id'];
               ...
               $fields = array('order_id_number__c' => $order_id_number,'flow_number__c'=>3,'client_id_number'=>$unique_id,'Client__c'=>$prevousnfo['client_c'],'document_number__c'=>$document_id);
            ...
            $session_array = array('business1', 'business2', 'business4', 'business5', 'business6', 'business7', 'business8', 'business9', 'business10', 'business11','propertyownerData');
                                       // $this->session->unset_userdata($session_array);
...
//              }
    ...
    function business_without_payment_api() {
        $postForm = $_POST;
          ...
          $startDate = strtr($_POST['startDate'], '/', '-');
             $postForm['startDate'] = date('Y-m-d', strtotime($startDate));
             
             $endDate = strtr($_POST['endDate'], '/', '-');
             $postForm['endDate'] = date('Y-m-d', strtotime($endDate));
        ...
        $order_id_number = $this->session->userdata('order_id_number');
           ...
           $business3 = $this->session->userdata('business3');
            ...
            $req_gur_amt = $postForm['req_gur_amt'];
           ...
           // first signature image start
            define('UPLOAD_DIR', 'doc_sign/');
              ...
              $new_doc_sign = $first_signature_file1;
              // $file_path1 = "222";
        ...
        if($req_gur_amt > 50000){
         ...
         /*** Creating new document with expiiry date ***/
...
//            print_r($this->session->userdata('business1'));
     ...
     $prevousnfo = $this->session->userdata('private6');
          
             $fields = array( "client_requested_amount__c" => $req_gur_amt, "client_first_signature_file__c" => $file_path2, 
            
            "guarantee_period_start_date__c" => $startDate, "guarantee_period_end_date__c" => $endDate,
            'order_id_number__c' => $order_id_number,'client_id_number'=>$unique_id,
            'flow_type__c'=>1,'form_type__c'=>3,'customer_credit_data__c'=>'',"first_document_url__c" => $customer_form_document,'ref_client_id__c'=>$TZId,'Annual_fee__c'=>6.5, 'Expiration_Date_of_Credit_Data__c'=>$expdate,'Client__c'=>$prevousnfo['client_c'],"End_Date_of_Credit_Transaction__c"=>$expdate2);
            ...
            "guarantee_period_start_date__c" => $startDate, "guarantee_period_end_date__c" => $endDate,
            'order_id_number__c' => $order_id_number,'flow_number__c'=>3,'client_id_number'=>$unique_id,'Client__c'=>$prevousnfo['client_c'],'customer_credit_data__c'=> '', "first_document_url__c" => $customer_form_document,'Annual_fee__c'=>6.5,'Expiration_Date_of_Credit_Data__c'=>$expdate,"End_Date_of_Credit_Transaction__c"=>$expdate2);
            
            $postForm['client_first_signature_file__c'] = $first_signature_file1;
            
            $postForm['client_second_signature_file__c'] = $second_signature_file1;
            
            $postForm['period_start_date'] = $startDate;
            
            $postForm['period_end_date'] = $endDate;
...
//             die();
     ...
     //end of New API for insert each form on SF //
            ...
            $this->createandSavedocumntsSF($postForm);
...
{
    $data = '{"client_id_number":"311226641","guarantee_type":"\u05e1\u05e4\u05e7\u05d9\u05dd \u05e2\u05e8\u05d1\u05d5\u05ea \u05dc\u05d0\u05e9\u05e8\u05d0\u05d9","preferred_route":"\u05de\u05e1\u05dc\u05d5\u05dc \u05dc\u05dc\u05d0 \u05e4\u05d9\u05e7\u05d3\u05d5\u05df","client_first_name":"Satendra Shukla","client_last_name":"Satendra","guarantee_period_month":14,"requested_amount":"55000","first_signature_file":"https:\/\/obli.co.il\/doc_sign\/5e3bed53d52d1.png","second_signature_file":"https:\/\/obli.co.il\/doc_sign\/5e3bed53d53531389011212.png","amt_company_name":"Tectum Techologies Pvt Ltd","amt_company_address":"test test","amt_company_id":"546546","amt_company_business_type":"\u05e2\u05d5\u05e1\u05e7 \u05e4\u05d8\u05d5\u05e8","amt_company_contact_person_email":"fdgfd@gmail.com","amt_company_contact_person_name":"546546","amt_company_contact_person_phone":"5210145411","ant_first_name":"546546","ant_last_name":"Test Satendra","ant_unique_id":"5654654","ant_client_email":"qw@gmail.com","ant_client_phone":"5210412012","ant_client_add":"test satendra","ant_req_gur_amt":"56565","ant_client_gender":"\u05d6\u05db\u05e8","ant_account_birth_date":"1983-04-28","ant_lease_period":12,"ant_client_file":"https:\/\/obli.co.il\/webservices\/obli_profile_images\/obli_158098415762.png","gr_company_name":"company 5_2_5","gr_company_address":"","gr_company_email":"","user_pdf":"https:\/\/obli.co.il\/doc_sign\/userPdf\/user_pdf5e3bed5415f971580985684.pdf","gr_company_phone":"","gr_company_url":"https:\/\/obli.co.il\/webservices\/obli_profile_images\/obli_158098417166.png","gurantee_articles_of_association":null,"gurantee_certificate":null,"gurantee_exemption_withholding_tax":null,"gurantee_bookkeeping_authorization":null,"gurantee_oval_attorney":null,"user_link":"https:\/\/obli.co.il\/business12\/dXNlcl9wZGY1ZTNiZWQ1NDE1Zjk3MTU4MDk4NTY4NC5wZGY=\/c2F0ZW5kcmEudGVjdHVtQGdtYWlsLmNvbQ==","first_document":"https:\/\/obli.co.il\/doc_sign\/first_document\/user_pdf5e3bed54363c11580985684.pdf","second_document":"https:\/\/obli.co.il\/doc_sign\/second_document\/user_pdf5e3bed548d7131580985684.pdf","b7_company_id":"","b7_contact_id":"","guarantee_period_start_date":"2020-02-06","guarantee_period_end_date":"2021-04-16","another_guarantee_period_start_date":"2020-02-06","another_guarantee_period_end_date":"2021-02-05","gurantee_direct_debit_authorization":null,"gr_other_company_name":"","order_id_number":" 3119405984"}';
   ...
   // print_r($fields);
    ...
    function createandSavedocumntsSF($business5){
     ...
     $business1 = $this->session->userdata('business1');
            ...
            $first_base64_signature = $business5['client_first_signature_file__c'];
            $second_base64_signature = $business5['client_second_signature_file__c'];
            $third_base64_sign = $business5['third_base64_signature'];
            $req_gur_amt = $business5['req_gur_amt'];
            $gur_period_month = $business5['gur_period_month'];
            $startDate = $business5['startDate'];
...
//            print_r($business6); 
            ...
            // first signature image start
              ...
              $first_signature_file = $business5['client_first_signature_file__c'];
              // $file_path1 = "222";
        ...
        // end
              ...
              $second_signature_file = $business5['client_second_signature_file__c'];
              // $file_path2 = "123";
        ...
        // user pdf and link generate (pdf details)
            ...
            //echo $b7_company_name; die;
            
        if($b7_company_name == 'Partner_1_1'){
            
            // Spacial Document Genrate & save to  SF //

$logo = $_SERVER["DOCUMENT_ROOT"].'/website_assets/img/logo.png';
...
$html = '<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
            ...
            <P DIR="RTL" CLASS="western" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%">
            <FONT FACE="David"><SPAN LANG="he-IL"><B> חברת פרטנר תקשורת בע"מ </SPAN></FONT><br>
            <FONT FACE="David"><SPAN LANG="he-IL">
רחוב העמל 8 </SPAN></FONT><br/>
<FONT FACE="David"><SPAN LANG="he-IL">
פארק תעשיות אפק </SPAN></FONT><br> <U> <FONT FACE="David"><SPAN LANG="he-IL">
ראש העין 84103
 </SPAN></FONT></U></B></SPAN></FONT></P>
 
 <P DIR="LTR" CLASS="western"><img src="'.$logo.'" width="100px">
            </P>
            ...
            <p DIR="RTL" CLASS="western" ALIGN=CENTER STYLE="text-align: center;">
                ...
                <FONT FACE="David"><SPAN LANG="he-IL"><B>הנדון</B></SPAN></FONT><B>:
            </B><FONT FACE="David"><SPAN LANG="he-IL"><U><B>ערבות מס</B></U></SPAN></FONT><U><B> '.$order_id_number.'</B></U>

            </p>

            <UL>

                <LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">
				
					בהתאם לבקשת <B> '.$name.' </B> ( להלן: "המבקש") אנו ערבים בזה כלפיך/ם לתשלום כל סכום עד לסכום כולל של 
 <B> '.$amount.' </B> ₪ [ בספרות ובמילים] (להלן: "סכום הערבות") שתדרוש/תדרשו מאת <B> '.$cmp[0].' </B> (להלן וביחד: "הנערב") בקשר עם ההסכם מיום <B> '.$startDate.' </B> על כל תוספותיו, ככל שיהיו מעת לעת (להלן: "ההסכם").
				...
				<LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">
						...
						סכום הערבות יהיה צמוד למדד המחירים לצרכן כפי שהוא מתפרסם מפעם לפעם על ידי הלשכה המרכזית לסטטיסטיקה ולמחקר כלכלי, כולל כל מדד רשמי שיבואו במקומו, בתנאי ההצמדה שלהלן:
				<br>
				</SPAN></FONT></P>
				...
				<LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">
						...
						אנו נשלם לך לפי דרישתך/כם הראשונה בכתב, ולא יאוחר משלושה ימי עבודה  מתאריך בו התקבלה דרישתך/כם למייל -⦁	info@obli.co.il   , כל סכום הנקוב בדרישה ובלבד שלא יעלה על סכום הערבות הצמוד למדד, מבלי להטיל עליך/כם חובה להוכיח או לבסס את דרישתך/כן ומבלי שתהיה/ו חייב/ים לדרוש את התשלום תחילה מאת הנערב. 
				<br>
				</SPAN></FONT></P>
				...
				"המדד היסודי" לעניין ערבות זו, יהא המדד בגין חודש <B>'.$startDate_m_Y[0].'</B> שנת <B>'.$startDate_m_Y[1].'</B>.
				<br>
				</SPAN></FONT></P>
				...
				<LI><P DIR="RTL"  id="pd"><FONT FACE="David"><SPAN LANG="he-IL">
						...
						"המדד החדש" לעניין ערבות זו, יהא המדד האחרון שפורסם בעת דרישת התשלום, על פי ערבות זו.
				<br>
				</SPAN></FONT></P>
				
				<LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">
				
						להודעת המייל כאמור,  יש לצרף את שטר ערבות שהתקבל במייל,  צילום תעודת זהות אישור ניהול חשבון בנק או צילום שיק מבוטל עם פרטי החשבון .
					<br>
				</SPAN></FONT></P>
			...
			<UL>
				...
				<LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">
						...
						, ולאחר תאריך זה תהיה בטלה ומבוטלת. כל דרישה על פי ערבות זו צריכה להתקבל על ידינו בכתב ולא יאוחר מהתאריך הנ"ל. <B>'.$endDate.'</B>	ערבות זו תישאר בתוקפה עד ליום
				<br>
				</SPAN></FONT></P>
				...
				<LI><P DIR="RTL"  id="pd"><FONT FACE="David"><SPAN LANG="he-IL">
							...
							כל תשלום על פי כתב ערבות זו יבוצע ע"י זיכוי חשבון במוסד בנקאי בישראל , כפי שיפורט בכתב הדרישה ערבות זאת אינה ניתנת להעברה ו/או להסבה.
					<br>
				</SPAN></FONT></P>
				...
				<LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">
								...
								ערבות זו ניתנת למימוש לשיעורין.
            ...
            <P DIR="LTR" CLASS="western">


<p style="margin: 30px 40px 0px 0px;text-align: left;">
                                    <FONT FACE="David"> בכבוד רב,
 </FONT> </p>
 
 
 <p style="margin: 30px 40px 0px 0px;text-align: right;">
                                    <FONT FACE="David"> גולדנרוד פיננסים בע"מ
 </FONT> </p>
...
*/
           ...
           $htmlsdata = base64_decode($business5['documenthtml']);
          ...
          $html2 .=  '<BR><P DIR="RTL" CLASS="western text_color" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%; text-align:center; font-weight: bold;">
            ...
            <img src="'.$business5["client_first_signature_file__c"].'" class="img-responsive" style="margin-left: 20px;">
...
<P DIR="RTL" CLASS="western" STYLE="margin-left: 0.02in; margin-bottom: 0in; line-height: 100%">
     ...
     <!-- <table STYLE="width:100%;">
        <tr>
            ...
            <LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL"> אנו ערבים בזה כלפיך/ם לתשלום כל סכום עד לסכום כולל של <B><U>'.$amount.'</U></B> ₪ (להלן: "סכום הערבות") שתדרוש/תדרשו מאת <B><U>'.$companyName.'</U></B>  '.$new_text.' <B><U>'.$company_id_change.'</U></B> (להלן וביחד: "הנערב") בקשר עם ההסכם מיום <B><U>'.$startDate.'</U></B>, על כל תוספותיו, ככל שיהיו מעת לעת (להלן: <B>"ההסכם"</B>).
 
                </SPAN></FONT></P>

<LI><P DIR="RTL"><FONT FACE="David"><SPAN LANG="he-IL">סכום הערבות יהיה צמוד למדד המחירים לצרכן כפי שהוא מתפרסם מפעם לפעם על ידי הלשכה     המרכזית לסטטיסטיקה ולמחקר כלכלי, בתנאי ההצמדה שלהלן:
<B>"המדד היסודי"</B> לעניין ערבות זו, יהא המדד שפורסם בגין חודש <B>'.$startDate_m_Y[1].'</B> שנה <B>'.$startDate_m_Y[0].'</B>.<br/>
<B>"המדד החדש"</B> לעניין ערבות זו, יהא המדד שפורסם לאחרונה וקודם לקבלת דרישתכם על פי ערבות זו.
הפרשי ההצמדה לעניין ערבות זו יחושבו כדלהלן: אם יתברר כי המדד החדש עלה לעומת המדד היסודי, יהיו הפרשי ההצמדה - הסכום השווה למכפלת ההפרש בין המדד החדש למדד היסודי בסכום הדרישה, מחולק במדד היסודי. אם המדד החדש יהיה נמוך מהמדד היסודי, נשלם לך/ם את הסכום הנקוב בדרישתך/ם עד לסכום הערבות, ללא כל הפרשי הצמדה. </SPAN></FONT>.</P>
            </OL>';
...
כל דרישה על פי ערבות זו צריכה להתקבל על ידינו בכתב ולא יאוחר מהתאריך הנ"ל.
 ...
 // End of house rent document //
           ...
           "guarantee_document__c"=>$house_rent_document,'user_link__c'=>$user_link,
            'order_id_number__c' => $order_id_number,'flow_number__c'=>3,'client_id_number'=>$unique_id,'Client__c'=>$prevousnfo['client_c'],'document_number__c'=>$document_id,'user_pdf_url__c'=>$user_pdf);
...
function callparetix(){
        ...
        $businessThird3 = $this->session->userdata('business5');
           
            $req_gur_amt = $businessThird3['req_gur_amt'];
            ...
            $Area__c = $business4['Area__c'];
            $Business_Field__c = $business4['Business_Field__c'];
