        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <div id="business_7_scr" class="gform_body form_height" style="margin-top: 30px;">
                            ...
                            <div class="main_text">
                    <p class="rtl main_text_heading" style="text-align:right;font-weight: bold;">היי <span id="spantext main_text_heading" class="spantext">דני</span>, שמחים לצרף אותך כלקוח OBLI </p>
                   ...
                   <div class="row" style="margin-top:50px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <!--<button type="submit" class="button gform_button first_main_button" id="businessFourth_payment_page_form" style="height: 60px; width: 328px;">המשך  </button>-->
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
