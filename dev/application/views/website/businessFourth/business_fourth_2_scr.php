...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#businessFouth_2_form").css("opacity","0.5"); 
            $("#businessFouth_2_form").css("cursor","auto");
            $('#businessFouth_2_form').prop('disabled', true);
            // $('#businessFouth_2_form').prop('disabled', false);
            ...
            $('#company_name,#company_id,#company_address,#contact_person_name,#contact_person_email,#contact_person_phone').on('keyup', function() {
                ...
                if($("#company_name").val() != '' && $("#company_id").val() != '' && $("#company_address").val() != '' && $("#contact_person_name").val() != ''  && $("#contact_person_email").val() != '' && $("#contact_person_phone").val() != '' ){
                    ...
                    $("#businessFouth_2_form").css("opacity","1"); // button opacity change
                    $("#businessFouth_2_form").css("cursor","pointer");
                    $('#businessFouth_2_form').prop('disabled', false);
            ...
            $("#businessFouth_2_form").click(function(){
                ...
                var form = $("#myform");
                    ...
                    if (form.valid() === true){
                        ...
                        $("#businessFouth_2_form").css("opacity","1"); 
                        $("#businessFouth_2_form").css("cursor","pointer");
                        $('#businessFouth_2_form').prop('disabled', false);
                    }
                    else{
      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessFourth2'); ?>" novalidate>
                  ...
                  <!-- screen 04  -->
                   ...
                   <div class="row" style="margin-top: 140px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <button type="submit" class="button gform_button first_main_button lowerbutton" id="businessFouth_2_form">המשך</button>
