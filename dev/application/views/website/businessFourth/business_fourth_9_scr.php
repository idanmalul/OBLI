            ...
            <div id="scr_eleven_form" class="gform_body form_height" style="margin-top: 30px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                             ...
                             <div class="screen5_after">
                                <img src="<?php echo base_url() ?>website_assets/img/Lock-n-Letter.gif"> 
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a class="button gform_button next"> <p class="first_next_button screen-button-obli screen-button2-obli screen-button3-obli padding_screen02 text_size" style="font-weight: 600; margin-top: 10px;">כתב הערבות   <span>
                            ...
                            <a class="button gform_button "> <p class="first_next_button screen-button-obli screen-button2-obli screen-button3-obli padding_screen02 text_size" style="margin-top: 30px; margin-bottom: 30px; font-weight: 600;">שליחת כתב הערבות  <span>
                             ...
                             <p class="rtl" style="text-align:center;">לכל שאלה, אל תהסס לפנות אלינו. תודה, צוות OBLI!  </p>
