         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('business3'); ?>" novalidate>
                    ...
                    <ul class="gform_fields top_label ">
                        ...
                        <li class="gfield gfield_html gfield_no_follows_desc "> 
                           <!--  <h1 class="page-subtitle page-subtitle_application">צור קשר</h1> -->
                            ...
                            <p class="contact-text_application">נשמח להציע לכם ערבות לאשראי ספקים, וגם להכיר אתכם  </p>
                        ...
                        <li class="gfield gf_left_third text-field2_application form-group">
                            ...
                            <div class="styled-input wide">
                               <input type="text" name="hometown" id="locality" value="" class="form-control hometown_text" required="">
                                <label class="gfield_label control-label gform_wrapper gfield_label needtopaddingremove" for="locality"> עיר מגורים
                            </label>
                            </div> 
                        </li>
                  ...
                  <div class="gform_footer top_label"> 
                        ...
                        <button type="submit" class="button gform_button first_next_button screen-button-obli screen-button2-obli screen-button3-obli screen_2_buttons padding_screen02 text_size" id="business_3_form" style="margin: 0px 180px;">המשך</button>
                    </div>
