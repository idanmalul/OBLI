         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('website/tenant_payment_api'); ?>" > 
                ...
                <div id="scr_first_form" class="gform_body">
                    <p class="rtl" style="text-align:center;font-weight: bold;"> היי, אנחנו OBLI </p> 

                     <p class="rtl" style="text-align:center; font-weight:  ">ואנחנו כאן כדי לפתוח בפניכם אפשרות  <br>חדשה לקבלת ערבות. </p><br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a class="button gform_button" href="<?php echo site_url('private1'); ?>" > <p class="first_main_button text_size" >לקוח פרטי</p></a>
