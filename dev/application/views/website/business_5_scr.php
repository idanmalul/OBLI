...
//                startDate : "01-10-2020",
      ...
      onSelect: function() {
             ...
             if($("#req_gur_amt").val() != '' && $("#gur_period_month").val() != '' && $("#endDate").val() != '' && $("#endDate").val() != '' && $('#checkbox3').is(":checked") && $('#checkbox4').is(":checked") != '' && $("#first_bae64_sign").val() != '' && $("#second_bae64_sign").val() != '' ){
                // alert(1);
      ...
      $('input[name="gur_period_month"]').on('apply.daterangepicker', function(ev, picker) {
          ...
          // alert($("#gur_period_month").val());
            ...
            if($("#req_gur_amt").val() != '' && $("#gur_period_month").val() != '' && $("#endDate").val() != '' && $('#checkbox3').is(":checked") && $('#checkbox4').is(":checked") != '' && $("#first_bae64_sign").val() != '' && $("#second_bae64_sign").val() != '' ){
                // alert(1);
                    $("#business_5_form").css("opacity","1"); // button opacity change
                    $("#business_5_form").css("cursor","pointer");
                    $("#business_5_form").prop("disabled", false);
...
//                        alert(11111);
                ...
                if($("#req_gur_amt").val() != '' && $("#gur_period_month").val() != '' && $("#endDate").val() != '' && $('#checkbox3').is(":checked") && $('#checkbox4').is(":checked") != '' && $("#first_bae64_sign").val() != '' && $("#second_bae64_sign").val() != '' && $("#third_bae64_sign").val() != '' ){
...
<input type='hidden' name='documenthtml' value='' id='documenthtml'>
   ...
   -->
            ...
            if(!empty($this->session->userdata("business3"))){
                $businessThird1 = $this->session->userdata("business3");
                             ...
                             <div class="row">
                                ...
                                <div class="col-md-10 rtl" id="modal2Div" style="text-align: right;">
                                    ...
                                    <?php $business4 = $this->session->userdata('business4');
                                     ...
                                     $businessThird2 = $business4;
                                     
                                     $business6 = $this->session->userdata('business7');
                                     
                                     $businessThird5['property_owner_name'] = $business6['name_company_indivisual'];
                        ...
                        <li class="gfield gf_left_third text-field1_application form-group">
                            ...
                            <div class="styled-input wide">
                               <input type="text" name="endDate" id="endDate" value="" class="form-control daterange seventh_text" data-format="MM/DD/YYYY" autocomplete="off" required="">
                                ...
                                <input type="hidden" name="monthsdifrence" id="monthsdifrence" >
...
//                            alert(66);
                            ...
                            if($("#value_check").val() == 1){
                                //location.href = "<?php echo site_url('business6'); ?>"; // Due to new apis
                                location.href = "<?php echo site_url('business8'); ?>";
...
//        console.log(data);
        ...
        if($("#req_gur_amt").val() != '' && $("#gur_period_month").val() != '' && $("#endDate").val() != '' && $("#first_bae64_sign").val() != '' && $("#second_bae64_sign").val() != '' && $("#third_bae64_sign").val() != '' ){
