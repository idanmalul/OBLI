      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('business9'); ?>" >
            <!-- screen 4/5 -->
            <div id="business_7_scr" class="gform_body form_height" style="margin-top: 30px;">
                            ...
                            <div class="main_text">
                    <p class="rtl main_text_heading main_text_heading_1" style="text-align:right;font-weight: bold;">היי <span id="spantext" class="main_text_heading main_text_heading_1"></span>, שמחים לצרף אותך כלקוח OBLI </p>
                    ...
                    <ul class="gform_fields top_label ">
                        ...
                        <li class="gfield gfield_html gfield_no_follows_desc" style="margin-top: 0px;">
                            ...
                            <?php // echo $this->session->userdata('businessFirst_payment_api_link'); ?>
                         <div class="row map_iframe">
                        <div class="col-md-12 col-sm-12">
                          <div class=""><iframe class="iframe_height" width="100%" height="100%"  src="<?php if(!empty($this->session->userdata('businessFirst_payment_api_link'))){ echo $this->session->userdata('businessFirst_payment_api_link'); } ?>"></iframe></div>
                        </div>
                    </div>   
                        </li>
...
<!--                            <button type="submit" class="button gform_button first_main_button" id="business_9_form" style="height: 60px; width: 328px;">המשך  </button>-->
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
