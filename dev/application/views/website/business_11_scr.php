      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
             ...
             <!--<form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php //echo site_url('business12/'.base64_encode($this->session->userdata('url_user_document')).'/'. base64_encode('satendra.tectum@gmail.com')); ?>">-->
            ...
            <div id="business_10_scr" class="gform_body form_height" style="margin-top: 30px;">
                <div class="" style="float: right; margin-left:15px; margin-top:-25px;">
                    ...
                    <div class="row">
                     ...
                     <!-- <p class="rtl" style="text-align:center;font-size: 22px;">נחזור אליך בעוד 2 ימי עסקים לאישור סופי הודעת SMS או במייל. <br>תודה שבחרת ב-OBLI!</p> -->
                     <!-- <p class="rtl" style="text-align:center;font-size: 22px;">
                        מזל טוב דני, הערבות שלך אושרה באופן עקרוני!

                        להשלמת התהליך, כעת אתה מתבקש להתקשר ממספר הטלפון הנייד שהזנת בטופס, לשם זיהוי במערכת.

                        התשלום ייעשה באמצעות כרטיס אשראי.
                        התקשר <b>072-2214966</b>. שלוחה **

                        מיד לאחר התשלום הטלפוני תישלח אלייך הערבות למייל.
                        שמחים לעמוד עבורך לכל שאלה, אובלי.

                         
                        כפתור 'סיים' -  בלחיצה עליו יישלח ללקוח  <b>SMS +MAIL</b> לסיום התהליך בתשלום דרך הטלפון.
                   ...
                   <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <!-- <button type="submit" class="button gform_button first_main_button" id="business_11_form" style="height: 60px; width: 328px;">חזור לדף הבית  </button> -->
                            <button type="submit" class="button gform_button first_main_button" id="business_11_form" style="height: 60px; width: 328px;"> סיים </button>
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
