      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('business10'); ?>" >
            <!-- screen 4/5 -->
            <div id="business_7_scr" class="gform_body form_height" style="margin-top: 30px;">
                    ...
                    <p class="rtl" style="text-align:right;font-weight: bold;font-size: 22px;">מידע על החברה</p>
                    ...
                    <div class="row" style="margin-top:15px;">
                        <div class="col-md-6 col-sm-6">
                           <div  id="selected-file5" style="padding-top:40px; display: none;">
                            ...
                            <label for="b10_fifth_file" id="b10_label5" style="margin-top: 8px;padding: 13.5px;">
                                ...
                                <span style="font-weight: 200; font-size: 22px; margin-left:0px; padding-top: 6px;"> טופס דוח מע"מ 6111 </span>
                            </label>
                       ...
                       <!--  <div class="col-md-2 col-sm-2"></div> -->
                        <div class="col-md-6 col-sm-6">
                           ...
                           <input type="file" name="b10_sixth_file" id="b10_sixth_file" class="inputfile inputfile-2" accept="image/gif,image/png,image/jpeg,image/jpg,application/pdf" style="display: none;" onchange="f6()">
                            ...
                            <!-- <label for="b10_fifth_file" style="margin-top: 8px;padding: 13.5px;"> -->
                                 <label for="b10_sixth_file" id="b10_label6" style="margin-top: 8px; white-space: unset; padding: 13.5px; border-radius: 35px;">
                               
                                <span style="font-weight: 200; font-size: 22px; margin-left:0px; padding-top: 6px;">פרוטוקול חברה חתום ע"י עו"ד</span>
                            </label>
                        ...
                        <div class="col-md-6 col-sm-6">
                           ...
                           <!-- <a href="<?php echo base_url() ?>website_assets/document.pdf" download style="color: #302861;" > <p class="first_button-new">מסמך הרשאה לחיוב חשבון   <i class="fa fa-download" aria-hidden="true" style="padding-left: 10px;"></i> </p></a>
                           <!--  <div class="primary-box"  style="float: right;">
                   ...
                   <div class="row" style="margin-top:40px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <!--<a class="button gform_button"> <p class="first_main_button">המשך  </p></a>-->
                            <input type="hidden" name="test10" value="1"/>
                            <button type="submit" class="button gform_button first_main_button" id="business_10_form" style="height: 60px; width: 328px;">המשך  </button>
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
...
// end
    ...
    $(document).ready(function(){
        ...
        $("#business_10_form").css("opacity","0.5"); 
        $("#business_10_form").css("cursor","auto");
        $('#business_10_form').prop('disabled', true);
        ...
        $('#b10_first_file,#b10_second_file,#b10_third_file,#b10_fourth_file,#b10_fifth_file,#b10_sixth_file').on('change', function() {
            ...
            // first checkbox
//            if($("#b10_first_file").val() != '' ){
//                    $("#b10_scr_checkbox1").show("fast");
//                    $("#checkbox1").prop("checked", true);
//                    // $('#checkbox1').prop('disabled',true);
//                    
//            }else{
//                $("#b10_scr_checkbox1").hide("fast");
//            }

            // second checkbox
//            if($("#b10_second_file").val() != '' ){
//                    $("#b10_scr_checkbox2").show("fast");
//                    $("#checkbox2").prop("checked", true);
//                
//            }else{
//                $("#b10_scr_checkbox2").hide("fast");
//
//            }

            // third checkbox
//            if($("#b10_third_file").val() != '' ){
//                    $("#b10_scr_checkbox3").show("fast");
//                    $("#checkbox3").prop("checked", true);
//
//            }else{
//                $("#b10_scr_checkbox3").hide("fast");
//
//            }

            // fourth checkbox
//            if($("#b10_fourth_file").val() != '' ){
//                    $("#b10_scr_checkbox4").show("fast");
//                    $("#checkbox4").prop("checked", true);
//                
//            }else{
//                $("#b10_scr_checkbox4").hide("fast");
//
//            }

            // fifth checkbox
//            if($("#b10_fifth_file").val() != '' ){
//                    $("#b10_scr_checkbox5").show("fast");
//                    $("#checkbox5").prop("checked", true);
//
//            }else{
//                $("#b10_scr_checkbox5").hide("fast");
//
//            }
            ...
            if($("#b10_first_file").val() != '' || $("#b10_second_file").val() != '' || $("#b10_third_file").val() != '' || $("#b10_fourth_file").val() != '' || $("#b10_fifth_file").val() != '' || $("#b10_sixth_file").val() != '' ){
                ...
                $("#business_10_form").css("opacity","1");
                $("#business_10_form").css("cursor","pointer");
                $('#business_10_form').prop('disabled', false);
            }
            else{
