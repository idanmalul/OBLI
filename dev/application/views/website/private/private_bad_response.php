            ...
            <!-- if getting bad response -->
                <div id="bad_screen" class="gform_body form_height" style="margin-top: 30px;">
                    ...
                    <p class="rtl" style="text-align:right; margin-top: -8px;"> בחר באחד משני המסלולים  </p>
                     ...
                     <p class="rtl" style="text-align:center;font-weight: bold; margin-top: 50px;">היי <span id="spantext" class="spantext">דני</span>, לצערנו הרב, הבקשה שלך לקבלת ערבות ללא פיקדון לא אושרה. </p>
