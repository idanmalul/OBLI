...
// end
    ...
    $(document).ready(function(){
        ...
        $('#autocomplete,#landlord,#landlord_id,#property_phone,#sec_email').on('keyup', function() {

            if($("#autocomplete").val() != '' && $("#landlord").val() != '' && $("#landlord_id").val() != '' && $("#property_phone").val() != '' && $("#sec_email").val() != '' && $("#sec_date_of_birth").val() != '' && $("#file-1").val() != '' ){
                    ...
                    <ul class="gform_fields top_label ">
                        ...
                        <li class="gfield gf_left_third text-field1_application form-group">
                            ...
                            <div class="styled-input wide">
                               <textarea class="textarea large form-control nine1_left" name="apartment_add" rows="5" cols="50" id="autocomplete" onFocus="geolocate()" required="" style="max-height: 56px;" ></textarea>
                             
                            <label class="gfield_label control-label gform_wrapper gfield_label" for="autocomplete">כתובת הנכס
                            </label>
                            </div>
                        </li>
                        ...
                        <li class="gf_middle_third gfield text-field1_application form-group">
                            ...
                            <div class="styled-input wide">
                               <input type="text" name="landlord_id" id="landlord_id" value="" class="form-control nine3_left" required="" maxlength='9'>
