      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessSec5'); ?>" >
            <!-- screen 4/5 -->
...
<?php $businessSec3 = $this->session->userdata('businessSec3'); if(!empty($businessSec3)){ $req_amt = str_replace(',', '', $businessSec3['businessSec_requested_gur_amount']); } ?>
                    
  <?php 
    
    if($businessSec3['guarenty_duration'] > 12){
        $tax = $businessSec3['guarenty_duration']/12*6/100; $annual_fee = 6;
    }else{
 ...
 ?>
                    ...
                    <ul class="gform_fields top_label ">
                        ...
                        <li class="gfield gfield_html gfield_no_follows_desc " style="margin-top: 30px;">
                            ...
                            <p class="contact-text_application rtl" style="text-align:center; font-weight: 600;">בחרת בערבות ללא עמלה, בהשוואה <br>לעמלה והאגרה המקובלת בבנקים  </p>
                    ...
                    <div class="modal-dialog_box" >
                        <div class="modal-content_box">
                            <div class="modal-header_box">
                                ...
                                <h3 class="modal-title_box rtl" id="myModalLabel">תחסוך בכל שנה כ- </h3>
                            </div>
...
<!--                    <div class="row" style="margin-top:100px;">
                   ...
                   <div class="row" style="margin-top:120px;" >
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a class="button gform_button"> <p class="first_button-new " style="color: #323474 !important; font-weight: normal;" id="myBtn3">הצהרות הלקוח </p></a>
