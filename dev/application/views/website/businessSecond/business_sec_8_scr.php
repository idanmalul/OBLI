            ...
            <div id="business_10_scr" class="gform_body form_height" style="margin-top: 30px;">
                   ...
                   <div class="row" style="margin-top:30px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <!-- <button type="submit" class="button gform_button first_main_button" id="businessSec_8_form" style="height: 60px; width: 328px;">חזור לדף הבית  </button> -->
                             <button type="submit" class="button gform_button first_main_button" id="businessSec_8_form" style="height: 60px; width: 328px;"> סיים </button>
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
