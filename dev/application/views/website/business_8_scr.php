      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('business8'); ?>" >
            <!-- screen 4/5 -->
            <div id="business_7_scr" class="gform_body form_height" style="margin-top: 0px;">
...
<?php $business5 = $this->session->userdata('business5'); if(!empty($business5)){ 
    $req_amt = str_replace(',', '', $business5['req_gur_amt']);
    ...
    if($business5['guarenty_duration'] > 12){
        $tax = $business5['guarenty_duration']/12*6/100; $annual_fee = 6;
    }else{
  ...
  //  $first_value = $req_amt*$tax;
   // $second_value = $first_value/12; 
    ...
    $business5['endDate'] =  str_replace('/', '-',$business5['endDate']);
   
   $business5['startDate'] =  str_replace('/', '-',$business5['startDate']);
   
   $number_of_days_str = strtotime($business5['endDate']) - strtotime($business5['startDate']);
            
    $number_of_days = round($number_of_days_str / (60 * 60 * 24)); 
    
    $number_of_days = $number_of_days + 1;
    
    $formula = $req_amt.'*'.$tax.'*'.$number_of_days.'/365';
    ...
    $second_value = $first_value; 
                    ...
                    <ul class="gform_fields top_label <?php echo $formula;?>">
                    ...
                    <div class="modal-dialog_box" >
                        <div class="modal-content_box">
                            ...
                            <div class="modal-body_box">
                                ...
                                <p class="rtl" style="text-align:center;font-weight: bold;font-size: 52px; margin-top: 10px;"><?php if(!empty($second_value)) echo number_format($second_value,2); ?> ₪ </p>
                                <!--
                                 <p class="contact-text_application rtl" style="text-align:center; width: 92%;margin: 0 auto;">עמלת הערבות השנתית הינה <?php echo $annual_fee;?>% ותעמוד על <?php if(!empty($first_value)) echo $first_value; ?> ₪ בשנה.  </p>
                   ...
                   <div class="row" style="margin-top:10px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                         ...
                         <a href="<?php echo site_url('terms'); ?>" target="_blank"><u style="color: #4EB5D7;">תנאי השימוש  </u></a>באתר  </p>
                            ...
                            <button type="button" class="button gform_button first_main_button" id="business_8_form" style="height: 60px; width: 328px; opacity:0.5;" disabled="true" onclick='callparetiixapi()'>המשך  </button>
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
...
<script>
    ...
    $("#accept-terms").change(function(){
        ...
        {
            $("#business_8_form").prop("disabled",false);
            
            $("#business_8_form").css("opacity","1");
        }else{
            $("#business_8_form").prop("disabled",true);
            
            $("#business_8_form").css("opacity","0.5");
        }
    });
