      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessThirdBadResponse'); ?>" >
            <!-- screen 4/5 -->
            ...
            <!-- if getting bad response -->
                <div id="bad_screen" class="gform_body form_height" style="margin-top: 30px;">
                    ...
                    <div class="" style="float: right; margin-left:15px; margin-top:-25px;">
                      ...
                      <div class="main_text">
                    <p class="rtl main_text_heading" style="text-align:right;font-weight: bold;"> ערבות לא אושרה  </p>

                    <p class="rtl" style="text-align:right; margin-top: -8px;"> בחר באחד משני המסלולים  </p>
                        </div>
                     <p class="rtl" style="text-align:center;font-weight: bold; margin-top: 50px;">היי <span id="spantext" class="spantext">דני</span>, לצערנו הרב, הבקשה שלך ערבות ללא פיקדון לא אושרה. </p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <a class="button gform_button" href="<?php echo site_url('business1'); ?>" > <p class="first_main_button" > ערבות עם פיקדון </p></a>
