      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessThird7'); ?>" >
            <!-- screen 4/5 -->
            <div id="business_7_scr" class="gform_body form_height" style="margin-top: 30px;">
                    ...
                    <ul class="gform_fields top_label ">
                        ...
                        <li class="gfield gfield_html gfield_no_follows_desc" style="margin-top: 0px;">
                            <p class="contact-text_application rtl" style="text-align:right;">כדי להשלים את התהליך ולקבל את הערבות נזדקק לפרטים הבאים:  </p>
                        ...
                        <div class="col-md-6 col-sm-6">
                           ...
                           <input type="file" name="b10_sixth_file" id="b10_sixth_file" class="inputfile inputfile-2" accept="image/gif,image/png,image/jpeg,image/jpg,application/pdf" style="display: none;" onchange="f6()">
                            ...
                            <!-- <label for="b10_fifth_file" style="margin-top: 8px;padding: 13.5px;"> -->
                                 <label for="b10_sixth_file" id="b10_label6" style="margin-top: 8px; white-space: unset; border-radius: 35px; padding: 13.5px;">
                   ...
                   <div class="row" style="margin-top:40px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <button type="submit" class="button gform_button first_main_button" id="businessThird_7_form" style="height: 60px; width: 328px;">המשך  </button>
                        </div>
                        <div class="col-md-3 col-sm-3"></div>
                    </div>
...
//        alert($("#b10_second_file").val());
            ...
            $("#businessThird_7_form").css("opacity","1");
            $("#businessThird_7_form").css("cursor","pointer");
            $("#businessThird_7_form").prop("disabled", false);

    }else{
//        alert(2);
//        alert($("#b10_second_file").val());
        $("#businessThird_7_form").css("opacity","0.5");
        $("#businessThird_7_form").css("cursor","auto");
        $("#businessThird_7_form").prop("disabled", true);
    }
}
// end
...
//    document.getElementById('for_file_label1').style.display = "none"
    ...
    if($("#b10_first_file").val() != '' || $("#b10_second_file").val() != '' || $("#b10_third_file").val() != '' || $("#b10_fourth_file").val() != '' || $("#b10_fifth_file").val() != '' || $("#b10_sixth_file").val() != '' ){
            ...
            $("#businessThird_7_form").css("opacity","1"); // button opacity change
            $("#businessThird_7_form").css("cursor","pointer");
            $("#businessThird_7_form").prop("disabled", false);

    }else{
        $("#businessThird_7_form").css("opacity","0.5"); // button opacity change
        $("#businessThird_7_form").css("cursor","auto");
        $("#businessThird_7_form").prop("disabled", true);
    }
}
...
// end
    ...
    $(document).ready(function(){
        ...
        $("#businessThird_7_form").click(function(){
          var form = $("#myform");
                form.validate({
                    errorElement: 'span',
