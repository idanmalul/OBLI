...
//                    alert(cmpType);
                    ...
                    if($("#company_name").val() != '' && $("#agent_id").val() != '' && $("#file-2").val() != '' && $("#autocomplete").val() != '' && $("#property_owner_name").val() != '' && $("#owner_of_property").val() != '' && $("#property_owner_phone").val() != '' && $("#property_owner_of_email").val() != '' ){
                        $("#businessThird_5_form").css("opacity","1");
                        $("#businessThird_5_form").css("cursor","pointer");
                        $('#businessThird_5_form').prop('disabled', false);
...
//                    alert(cmpType);
                    ...
                    if($("#company_name").val() != '' && $("#file-2").val() != '' && $("#autocomplete").val() != '' && $("#property_owner_name").val() != '' && $("#owner_of_property").val() != '' && $("#property_owner_phone").val() != '' && $("#property_owner_of_email").val() != '' ){
//                        alert(1);
                        $("#businessThird_5_form").css("opacity","1");
                        $("#businessThird_5_form").css("cursor","pointer");
                        $('#businessThird_5_form').prop('disabled', false);
...
//                    alert(cmpType);
        ...
        //      $('#' + $(this).val()).show();
            ...
            $('#company_address,#other_company_name,#company_telephone,#company_email,#agent_id,#company_id,#autocomplete,#property_owner_name,#owner_of_property,#property_owner_phone,#property_owner_of_email').on('keyup', function(){
...
//            });
            ...
            $("#businessThird_5_form").click(function(){
                ...
                var inputemail = $("#property_owner_of_email").val();
                ...
                var form = $("#myform");
                    form.validate({
                        ...
                        messages: {
                            ...
                            owner_of_property: {
                                required: "שדה חובה",
                                minlength: "נא להזין 9 ספרות בשד",
                            },
                            property_owner_phone: {
                                required: "שדה חובה",
            ...
            <div id="business_6_scr" class="gform_body form_height" style="margin-top: 30px;">
                    ...
                    <ul class="gform_fields top_label ">
                        ...
                        <li class="gfield gf_left_third text-field1_application form-group">
                            ...
                            <div class="styled-input wide">
                               ...
                               <select name="company_name" id="company_name" value="" class="form-control left_lbl1_4 selector_obli" required="">
                                    <option value="" id="selectHide" selected="" disabled="" hidden=""> בעל הנכס / החברה  </option>
                        ...
                        <li class="gfield gf_left_third text-field2_application form-group">
                           <div class="styled-input wide">
                               <textarea class="textarea large form-control company_address_left" name="property_address" id="autocomplete" onFocus="geolocate()" rows="5" cols="50" required="" style="max-height: 56px;" ><?php if(!empty($bus7_param['property_address'])){ echo $bus7_param['property_address']; } ?></textarea>
                        ...
                        <li class="gfield gf_left_third text-field2_application form-group">
                             <div class="styled-input wide">
                               <input type="text" name="owner_of_property" id="owner_of_property" value="<?php if(!empty($bus7_param['owner_of_property'])){ echo $bus7_param['owner_of_property']; } ?>" class="form-control" required="" maxlength='9'>
                                <label class="gfield_label control-label gform_wrapper gfield_label third_text" for="owner_of_property"> חפ / תז בעל החברה
                            </label>
                            </div> 
                        </li>
                        ...
                        <li class="gfield gf_left_third text-field1_application form-group">
                            <div class="styled-input wide">
                               <input type="text" name="property_owner_phone" id="property_owner_phone" value="<?php if(!empty($bus7_param['property_owner_phone'])){ echo $bus7_param['property_owner_phone']; } ?>" class="form-control client_phone_text" required="" maxlength="10">
                        ...
                        <li class="gf_left_third gfield text-field1_application form-group" style="margin-top: 5px;">
                           ...
                           <input type="file" name="file-2" id="file-2" class="inputfile inputfile-2" accept="image/gif,image/png,image/jpeg,image/jpg,application/pdf" style="display: none;">
                  ...
                  <div class="gform_footer top_label"> 
                        <button type="submit" class="first_next_button screen-button-obli screen-button2-obli screen-button3-obli screen_2_buttons padding_screen02 text_size" id="businessThird_5_form" style="margin: 35.5px 180px;">המשך</button>
...
$( document ).ready(function() {
   ...
   setTimeout(function(){ $('#autocomplete').removeAttr('placeholder'); },500);

    <?php if(!empty($this->session->userdata['businessThird1'])){ 


      $clientdetails = $this->session->userdata['businessThird1'];
