...
<!-- calendar start -->
 ...
 <script type="text/javascript" src="https://cdn.jsdelivr.net/momentjs/latesct/moment.min.js"></script>
...
<div id="content" class="contact">
  ...
  <?php $businessThird3 = $this->session->userdata('businessThird3'); if(!empty($businessThird3)){ 
    ...
    $businessThird3['endDate'] =  str_replace('/', '-',$businessThird3['endDate']);
   
   $businessThird3['startDate'] =  str_replace('/', '-',$businessThird3['startDate']);
    
      $number_of_days_str = strtotime($businessThird3['endDate']) - strtotime($businessThird3['startDate']);
