...
<script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $.validator.addMethod('customphone', function (value, element) {
               ...
               var countstr = value.replaceAll("_", "");
               
               countstr = countstr.replaceAll("-", "");
                
                
              if(countstr.trim().length == 9){
                
                  return this.optional(element) || countstr.trim().length > 8;
            ...
            }, "מספר הטלפון מוכרח להיות 9 תווים");
            ...
            $("#businessThird_2_form").click(function(){
                ...
                var form = $("#myform");
                    form.validate({
                        ...
                        messages: {
                            ...
                            contact_person_phone: {
                                required: "שדה חובה",
                                phoneStartingWith: 'חייב להתחיל בספרה 0'
                            },
                            contact_person_email: {
                                required: "שדה חובה",
...
<script>
    ...
    phone_number = phone_number.replace(/\s+/g, "");
    return this.optional(element) || phone_number.match(/^0|0;/);
      ...
      <div class="contact-content clearfix">
        ...
        <?php } ?>
         ...
         <div class="gf_browser_chrome gform_wrapper gform_wrapper_application" id="gform_wrapper_5">
            ...
            <form method="post" enctype="multipart/form-data" id="myform" name="validate_form" action="<?php echo site_url('businessThird2'); ?>" novalidate>
                  ...
                  <!-- screen 04  -->
                    ...
                    <ul class="gform_fields top_label ">
                      ...
                      <div class=""style="float: left; margin-right: -10px;">
                           ...
                           <!--   <input type="radio" name="radio-box" id="box-2" checked="checked">רכז -->
                             ...
                             <input type="radio" name="business_type" value='עוסק מורשה' id="box-1" style="left: 120px;top: -6px;">עוסק מורשה
                            </label>
                            </div>
                        </label>
                        ...
                        <li class="gf_left_third gfield text-field1_application form-group">
                            ...
                            <div class="styled-input wide">
                               <input type="text" name="contact_person_name" id="contact_person_name" value="" class="form-control confirmed_contact_left" required="">
                                <label class="gfield_label control-label gform_wrapper gfield_label" for="contact_person_name">שם אישר קשר
                            </label>
                            </div>
                        </li>
                   ...
                   <div class="row" style="margin-top: 40px;">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <button type="submit" class="button gform_button first_main_button lowerbutton" id="businessThird_2_form">המשך</button>
