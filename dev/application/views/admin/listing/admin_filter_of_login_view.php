    ...
    <div class="panel-heading">
        <div class="panel-title">
         ...
         <div class="panel-options">
            <!-- <a href="<?php echo site_url('index.php/index.php/admin/add_agent'); ?>" class="btn btn-turquoise fa-plus-circle" style="color: #fff;">
                Add Agent
            </a> --> 
        </div> 
    </div>
                    ...
                    foreach ($customer_loan_detail as $v) {
                        ...
                        <?php } }  ?>
                            ...
                            <td width="10%">
                                ...
                                <!-- <a href="<?php echo site_url('index.php/admin/change_status') . '/id/' . $v->id; ?>/new_login/status/1/new_login_list" class="btn btn-secondary btn-sm btn-icon icon-left" data-toggle="tooltip" data-placement="right" title=""><i class="fa fa-check"></i>Approved</a>
                               
                                
                                <a href="<?php echo site_url('index.php/admin/change_status') . '/id/' . $v->id; ?>/new_login/status/2/new_login_list" class="btn btn-warning btn-sm btn-icon icon-left" data-toggle="tooltip" data-placement="right" title="" ><i class="fa fa-exclamation"></i> Pending</a><br><br>                                
                                <a href="<?php echo site_url('index.php/admin/change_status') . '/id/' . $v->id; ?>/new_login/status/3/new_login_list" class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="" ><i class=""></i> Rejected</a>

                                 
                                
                                <a href="<?php echo site_url('index.php/admin/change_status') . '/id/' . $v->id; ?>/new_login/status/4/new_login_list" class="btn btn-info " data-toggle="tooltip" data-placement="right" title="" ><i class=""></i> Disbursed</a><br><br> -->
                                ...
                                <!-- <a href="<?php echo site_url('index.php/admin/edit_new_login') . '/' . $v->id; ?>" class="btn btn-blue btn-sm btn-icon icon-left" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-pencil"></i> Edit</a> -->
...
function save_row(id)
{
 ...
 ({
  type:'post',
  url:'<?php echo site_url('index.php/admin/update'); ?>',
  data:{
   edit_row:'edit_row',
   row_id:id,
   status_val:status,
