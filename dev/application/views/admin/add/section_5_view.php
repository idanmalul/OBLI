...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($section_5_detail)) echo site_url('index.php/admin/edit_section_5'); else echo site_url('index.php/admin/add_section_5'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
