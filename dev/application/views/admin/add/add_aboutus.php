...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($aboutus_detail)) echo site_url('index.php/admin/edit_aboutus'); else echo site_url('index.php/admin/add_aboutus'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
