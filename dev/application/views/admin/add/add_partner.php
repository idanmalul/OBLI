...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($partner_detail)) echo site_url('index.php/admin/edit_partner'); else echo site_url('index.php/admin/add_partner'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
