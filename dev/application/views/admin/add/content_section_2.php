...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($content_detail)) echo site_url('index.php/admin/edit_section_2'); else echo site_url('index.php/admin/add_section_2'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
            ...
            <div class="form-group">
                ...
                <textarea name="new_title_text_first" id="text_area" class="form-control ckeditor ck_textarea_visible" placeholder="" rows="5" ><?php if(!empty($content_detail)){ echo trim($content_detail[0]->first_sub_title_text); }else{ if(isset($_POST['first_sub_title_text'])){ echo trim($_POST['first_sub_title_text']); } }?></textarea>
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                ...
                <textarea name="new_title_text_second" id="text_area2" class="form-control ckeditor ck_textarea_visible" placeholder="" rows="5" ><?php if(!empty($content_detail)){ echo trim($content_detail[0]->second_sub_title_text); }else{ if(isset($_POST['second_sub_title_text'])){ echo trim($_POST['second_sub_title_text']); } }?></textarea>
