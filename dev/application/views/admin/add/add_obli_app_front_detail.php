...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($admin_detail)) echo site_url('index.php/admin/edit_front_ui'); else echo site_url('index.php/admin/add_front_ui'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
