...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($company_details)) echo site_url('index.php/admin/edit_company'); else echo site_url('index.php/admin/add_company'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
