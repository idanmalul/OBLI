...
<div class="row">
    ...
    <div class="panel-body">
        ...
        <form action="<?php if(!empty($login_detail)) echo site_url('index.php/admin/edit_new_login'); else echo site_url('index.php/admin/add_new_login'); ?>" role="form" id="form1" method="post" enctype="multipart/form-data" class="validate">
